...
const ZH_MAP: Record<string, string> = {
  ...
  'Blank': '空',
  'Random': '随机',
  'Default Session Icon': '默认会话图标',
  'Icon for new sessions. Switching also resets all open sessions.': '新建会话使用的图标。切换会同时重置所有已打开的会话。',
  'Scheduled Task': '定时任务',
  'Running': '运行中',
  'Warning': '警告',
  ...
  'Save': '保存',
  "Don't Save": '不保存',
  'File has unsaved changes': '文件有未保存的修改',
  'Closing will discard unsaved changes. Save first?': '关闭将丢失未保存的修改，是否先保存？',
  'Files have unsaved changes': '文件有未保存的修改',
  ...
  'Show the Clown Code row at the top of the sidebar (app icon, name, and the version / language menu).': '在侧栏顶部显示 Clown Code 那一栏（App 图标、名称，以及版本号 / 中英文菜单）。',
  ...
  '{hits} results in {files} files': '{files} 个文件中有 {hits} 个结果',
  'Language server starting — retry in a moment': '语言服务器启动中 — 请稍后重试',
  "clangd can't resolve header includes without a compile database, and this project has none": 'clangd 缺少编译数据库，无法解析 #include 的头文件路径；当前工程里没有',
  'CMake projects: rerun cmake with -DCMAKE_EXPORT_COMPILE_COMMANDS=ON': 'CMake 工程：用 -DCMAKE_EXPORT_COMPILE_COMMANDS=ON 重新跑一次 cmake',
  'Generate compile_flags.txt (-I<project root>)': '生成 compile_flags.txt（写入 -I<工程根>）',
  'Generating...': '生成中...',
  'Failed to write compile_flags.txt': '写入 compile_flags.txt 失败',
  ...
  'New todo': '新增待办',
  'Edit todo': '编辑待办',
  'Write a todo…': '输入待办内容，Ctrl+Enter 保存；每行逐轮次发送',
  'Save (Ctrl+Enter)': '保存 (Ctrl+Enter)',
  'Delete todo': '删除待办',
  'Todo drag hint': '拖到「空闲」会话即作为输入发送',
  'New terminal': '新建终端',
  ...
  'branches': '个分支',
  'Fit to view': '适应视图',
  'No conversation to map yet': '暂无可视化的对话',
  'Continue from this turn': '从这一轮继续',
  '(empty)': '(空)',
  '(no reply)': '(无回复)',
  'tools': '工具',
  'Sending in current branch': '在当前分支发送',
  'Continue in that branch': '在该分支继续',
  'Fork a new branch': '分叉新分支',
  'Open branch': '打开分支',
  'Message to start a new branch...': '输入消息，开启新分支…',
  'Message...': '输入消息…',
  'Fork & Send': '分叉并发送',
