...
// 苍绿亮化一档做舞台底色，樱粉紫 #C286BE 接管全部高亮点缀
const miku: IDETheme = {
  id: 'miku',
  label: 'Hatsune Miku',
  css: {
    'ide-bg': t('#1d5752'),
    'ide-sidebar': t('#174d47'),
    'ide-panel': t('#21645c'),
    'ide-border': t('#2f7a71'),
    'ide-text': t('#ecfdf9'),
    'ide-text-muted': t('#93cfc6'),
    'ide-accent': t('#C286BE'),
    'ide-accent-hover': t('#D8A0CC'),
    'ide-success': t('#C286BE'),
    'ide-danger': t('#ff7d9c'),
    'ide-warning': t('#fad26e'),
    'ide-hover': t('#286b62'),
    'ide-active': t('#2e746b'),
    'scrollbar-thumb': t('#2f7a71'),
    'scrollbar-thumb-hover': t('#C286BE'),
    'selection-bg': t('#C286BE'),
    'selection-opacity': '0.3',
    'focus-outline': t('#C286BE'),
    'monaco-margin-bg': t('#1d5752')
  },
  terminal: {
    background: '#1d5752',
    foreground: '#ecfdf9',
    cursor: '#C286BE',
    cursorAccent: '#1d5752',
    selectionBackground: hexToRgba('#C286BE', 0.35),
    black: '#14453e',
    red: '#ff7d9c',
    green: '#5ce0c0',
    yellow: '#f5cc6e',
    ...
    brightYellow: '#f8e090',
    brightBlue: '#90d0ff',
    brightMagenta: '#E0A8CC',
    brightCyan: '#9af0e8',
    brightWhite: '#ffffff'
  },
  monacoTheme: 'vibe-ide-miku',
  monacoRules: [
    { token: 'comment', foreground: '#7fd4bd', fontStyle: 'italic' },
    { token: 'keyword', foreground: '#6fc8ff' },
    { token: 'string', foreground: '#C286BE' },
    { token: 'number', foreground: '#c4e8cf' },
    { token: 'type', foreground: '#DB9FD2' },
    { token: 'function', foreground: '#e3d97c' },
    { token: 'variable', foreground: '#b8e2ff' },
    { token: 'constant', foreground: '#63ccff' },
    { token: 'regexp', foreground: '#e0837f' }
  ],
  titleBar: { color: '#174d47', symbolColor: '#C286BE', backgroundColor: '#174d47' }
}
