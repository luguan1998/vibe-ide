  ...
  return (
    <div className="flex flex-col h-full animate-fade-in" style={{ cursor: pick ? 'crosshair' : 'default' }}>
      <div className="h-8 px-3 flex items-center gap-1.5 bg-ide-sidebar border-b border-ide-border shrink-0">
        <button onClick={onBack} className="w-6 h-6 mr-1 rounded text-ide-text-muted bg-ide-hover hover:bg-ide-accent hover:text-white flex items-center justify-center transition-colors shrink-0" title={t('Close')}>
