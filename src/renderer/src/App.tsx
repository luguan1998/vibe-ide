    ...
    <div className="h-full w-full flex flex-col bg-ide-bg">
      ...
      <div className="titlebar-drag h-9 bg-ide-sidebar border-b border-ide-border flex items-center px-4 select-none shrink-0">
        <div className="status-badge">
          <span
            className={`status-badge__segment status-badge__segment--running${statusStats.running > 0 ? ' is-active' : ''}`}
            title={t('running')}
          >
            <Zap size={13} className={`status-badge__icon${statusStats.running > 0 ? ' animate-zap-glow' : ''}`} />
            <span className="status-badge__count">{statusStats.running}</span>
          </span>
          ...
          >
            ...
            <span className="status-badge__count">{statusStats.idle}</span>
          </span>
          <span className="status-badge__divider" />
          <span
            className={`status-badge__segment status-badge__segment--warn${statusStats.warn > 0 ? ' is-active' : ''}`}
            title={t('warn')}
          >
            ...
            <span className="status-badge__count">{statusStats.warn}</span>
          </span>
        </div>
        <button
