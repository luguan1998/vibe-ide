window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:E:\ai\deepseek-harness\packages\extensions\ui-cordis\src\client\CordisRunRow.module.css.mjs
		const css$2 = "._8QE1ma_card{flex-direction:column;gap:8px;display:flex}._8QE1ma_row{align-items:center;min-height:32px;display:flex}._8QE1ma_icon{color:var(--dsw-alias-state-business-primary);flex:none;margin-right:8px;display:inline-flex}._8QE1ma_title{color:var(--dsw-alias-state-business-primary);flex:none;font-size:14px;font-weight:500;line-height:24px}._8QE1ma_separator{background:var(--dsw-alias-state-business-primary);border-radius:50%;flex:none;width:2px;height:2px;margin:0 8px}._8QE1ma_summary,._8QE1ma_error{min-width:0;color:var(--dsw-alias-label-secondary);text-overflow:ellipsis;white-space:nowrap;flex:1;font-size:13px;line-height:24px;overflow:hidden}._8QE1ma_error{color:var(--dsw-alias-state-error-primary)}._8QE1ma_status{color:var(--dsw-alias-label-caption);flex:none;margin-left:8px;font-size:12px;line-height:24px}._8QE1ma_card[data-cordis-status=awaiting-approval] ._8QE1ma_status,._8QE1ma_card[data-cordis-status=client-pending] ._8QE1ma_status{color:var(--dsw-alias-state-warn-label)}._8QE1ma_card[data-cordis-status=running] ._8QE1ma_status{color:var(--dsw-alias-state-success-primary)}._8QE1ma_card[data-cordis-status=failed] ._8QE1ma_status{color:var(--dsw-alias-state-error-primary)}._8QE1ma_inspect{width:24px;height:24px;color:var(--dsw-alias-label-tertiary);cursor:pointer;opacity:0;background:0 0;border:none;border-radius:999px;justify-content:center;align-items:center;margin-left:4px;padding:0;display:inline-flex}._8QE1ma_card:hover ._8QE1ma_inspect,._8QE1ma_inspect:focus-visible{opacity:1}._8QE1ma_inspect:hover{background:var(--dsw-alias-interactive-bg-hover)}._8QE1ma_message{background:var(--dsw-alias-button-ghost-active-fill);color:var(--dsw-alias-label-tertiary);border-radius:8px;padding:8px 12px;font-size:12px;line-height:18px}._8QE1ma_business{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-base);border-radius:12px;min-width:0;overflow:hidden}._8QE1ma_output{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-markdown-code-block);color:var(--dsw-alias-label-secondary);font:var(--dsw-font-markdown-code-block-small);white-space:pre-wrap;overflow-wrap:anywhere;border-radius:8px;margin:0;padding:10px 12px;overflow:auto}._8QE1ma_business ._8QE1ma_output{border:none;border-radius:0}";
		...
		var CordisRunRow_module_css_default = {
			...
			"icon": "_8QE1ma_icon",
			"error": "_8QE1ma_error",
			"separator": "_8QE1ma_separator",
			"inspect": "_8QE1ma_inspect",
			"message": "_8QE1ma_message",
			"output": "_8QE1ma_output",
			"title": "_8QE1ma_title",
			"summary": "_8QE1ma_summary",
			"business": "_8QE1ma_business",
			"status": "_8QE1ma_status",
			"row": "_8QE1ma_row"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:E:\ai\deepseek-harness\packages\extensions\ui-cordis\src\client\CordisDefineRow.module.css.mjs
		const css$1 = ".BVuvWq_card{flex-direction:column;display:flex}.BVuvWq_card .BVuvWq_title,.BVuvWq_card .BVuvWq_chevron{color:var(--dsw-alias-state-business-primary)}.BVuvWq_title{flex:none;font-size:14px;font-weight:500;line-height:24px}.BVuvWq_row{gap:0}.BVuvWq_separator{background:var(--dsw-alias-state-business-primary);border-radius:1px;flex:none;width:2px;height:2px;margin:0 8px}.BVuvWq_name{text-overflow:ellipsis;white-space:nowrap;max-width:40%;color:var(--dsw-alias-label-secondary);flex:none;font-size:14px;line-height:24px;overflow:hidden}.BVuvWq_purpose{text-overflow:ellipsis;white-space:nowrap;min-width:0;color:var(--dsw-alias-label-tertiary);flex:auto;margin-left:8px;font-size:13px;line-height:24px;overflow:hidden}.BVuvWq_errorSummary{text-overflow:ellipsis;white-space:nowrap;min-width:0;color:var(--dsw-alias-state-error-primary);flex:auto;font-size:14px;line-height:24px;overflow:hidden}.BVuvWq_requestError{text-overflow:ellipsis;white-space:nowrap;max-width:40%;color:var(--dsw-alias-state-error-primary);flex:none;margin-left:8px;font-size:12px;line-height:24px;overflow:hidden}.BVuvWq_readout{flex:none;align-items:center;margin-left:8px;display:inline-flex}.BVuvWq_panelHint{color:var(--dsw-alias-label-caption);margin:4px 0 2px 4px;font-size:11px;line-height:16px}.BVuvWq_statusLabel{color:var(--dsw-alias-label-caption);font-size:12px;line-height:24px}.BVuvWq_approvalPrompt{text-overflow:ellipsis;white-space:nowrap;max-width:40%;color:var(--dsw-alias-label-secondary);flex:none;margin-left:8px;font-size:12px;line-height:24px;overflow:hidden}.BVuvWq_notice{text-overflow:ellipsis;white-space:nowrap;max-width:40%;color:var(--dsw-alias-label-caption);flex:none;margin-left:8px;font-size:12px;line-height:24px;overflow:hidden}.BVuvWq_switch{height:22px;padding:0 8px;font-size:12px}.BVuvWq_card[data-terminal] .BVuvWq_title,.BVuvWq_card[data-terminal] .BVuvWq_name,.BVuvWq_card[data-terminal] .BVuvWq_purpose,.BVuvWq_card[data-terminal] .BVuvWq_statusLabel{color:var(--dsw-alias-label-caption)}.BVuvWq_card[data-terminal] .BVuvWq_separator{background:var(--dsw-alias-label-caption)}.BVuvWq_bodyWrap{flex-direction:column;display:flex}.BVuvWq_sourceCard{flex-direction:column;margin:4px 0 4px 4px;display:flex}.BVuvWq_sourceTabs{border-bottom:1px solid var(--dsw-alias-border-l2);height:32px;display:flex}.BVuvWq_sourceTab{color:var(--dsw-alias-label-tertiary);cursor:pointer;font:var(--dsw-font-xs-13);background:0 0;border:0;padding:0 10px;position:relative}.BVuvWq_sourceTab:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-primary)}.BVuvWq_sourceTab:disabled{cursor:default;opacity:.4}.BVuvWq_sourceTabActive{color:var(--dsw-alias-state-business-primary)}.BVuvWq_sourceTabActive:after{background:var(--dsw-alias-state-business-primary);content:\"\";border-radius:1px 1px 0 0;height:2px;position:absolute;bottom:0;left:10px;right:10px}.BVuvWq_sourceTab:focus-visible{outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:-1px}.BVuvWq_sourcePanel{max-height:260px;overflow:auto}.BVuvWq_sourceCode{margin:0}.BVuvWq_codeSection{flex-direction:column;max-height:260px;margin:4px 0 4px 4px;display:flex;overflow:auto}.BVuvWq_sectionLabel{color:var(--dsw-alias-label-caption);text-transform:uppercase;letter-spacing:.04em;flex:none;padding:2px 0;font-size:11px;font-weight:500;line-height:16px}.BVuvWq_output{border:1px solid var(--dsw-alias-border-l1);background:var(--dsw-alias-markdown-code-block);white-space:pre-wrap;overflow-wrap:anywhere;font:var(--dsw-font-markdown-code-block-small);color:var(--dsw-alias-label-secondary);border-radius:8px;margin:0;padding:8px 10px}.BVuvWq_output[data-error]{color:var(--dsw-alias-state-error-primary)}.BVuvWq_inspectButton{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-base);color:var(--dsw-alias-label-secondary);cursor:pointer;opacity:0;border-radius:999px;align-self:flex-start;align-items:center;gap:4px;margin:4px 0 2px 4px;padding:2px 8px;font-size:11px;line-height:16px;transition:opacity .1s;display:inline-flex}.BVuvWq_card:hover .BVuvWq_inspectButton,.BVuvWq_inspectButton:focus-visible{opacity:1}.BVuvWq_inspectButton:hover{background:var(--dsw-alias-interactive-bg-hover-solid);color:var(--dsw-alias-label-primary)}.BVuvWq_visuallyHidden{clip:rect(0 0 0 0);white-space:nowrap;width:1px;height:1px;position:absolute;overflow:hidden}@media (prefers-reduced-motion:reduce){.BVuvWq_inspectButton{transition:none}}";
		...
		var CordisDefineRow_module_css_default = {
			"row": "BVuvWq_row",
			"readout": "BVuvWq_readout",
			"separator": "BVuvWq_separator",
			"sourceTabs": "BVuvWq_sourceTabs",
			"bodyWrap": "BVuvWq_bodyWrap",
			"errorSummary": "BVuvWq_errorSummary",
			"title": "BVuvWq_title",
			"sourceTab": "BVuvWq_sourceTab",
			"card": "BVuvWq_card",
			"name": "BVuvWq_name",
			"requestError": "BVuvWq_requestError",
			"notice": "BVuvWq_notice",
			"sourcePanel": "BVuvWq_sourcePanel",
			"sectionLabel": "BVuvWq_sectionLabel",
			"output": "BVuvWq_output",
			"chevron": "BVuvWq_chevron",
			"inspectButton": "BVuvWq_inspectButton",
			"sourceCard": "BVuvWq_sourceCard",
			"sourceTabActive": "BVuvWq_sourceTabActive",
			"approvalPrompt": "BVuvWq_approvalPrompt",
			"panelHint": "BVuvWq_panelHint",
			"purpose": "BVuvWq_purpose",
			"sourceCode": "BVuvWq_sourceCode",
			"switch": "BVuvWq_switch",
			"codeSection": "BVuvWq_codeSection",
			"visuallyHidden": "BVuvWq_visuallyHidden",
			"statusLabel": "BVuvWq_statusLabel"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:E:\ai\deepseek-harness\packages\extensions\ui-cordis\src\client\CordisPanel.module.css.mjs
		const css = ".zHeOwq_layer{flex:none;align-items:center;width:100%;height:49px;margin:8px 0 0;display:flex;position:relative}.zHeOwq_footerButtons{align-items:center;width:100%;display:flex}.zHeOwq_badge{width:100%;height:49px;color:var(--dsw-alias-label-primary);cursor:pointer;background:0 0;border:none;border-radius:12px;align-items:center;gap:8px;padding:0 8px 0 6px;font-family:inherit;font-size:14px;display:inline-flex;overflow:hidden}.zHeOwq_badge:hover{background:var(--dsw-alias-interactive-bg-hover-solid)}.zHeOwq_badge[data-active]{background:var(--dsw-alias-interactive-bg-hover)}.zHeOwq_badgeLabel{text-overflow:ellipsis;white-space:nowrap;min-width:0;overflow:hidden}.zHeOwq_badgeCount{color:var(--dsw-alias-label-tertiary);font-variant-numeric:tabular-nums;flex:none;margin-left:auto;font-size:12px;line-height:16px}.zHeOwq_layer.zHeOwq_rail{width:36px;height:36px;margin:0}.zHeOwq_rail .zHeOwq_badge{border-radius:50%;justify-content:center;gap:0;width:36px;height:36px;padding:0}.zHeOwq_rail .zHeOwq_footerButtons{flex-direction:column;gap:2px}.zHeOwq_panel{z-index:30;border:1px solid var(--dsw-alias-border-l1);background:var(--dsw-alias-bg-base);width:420px;max-width:calc(100vw - 24px);max-height:60vh;box-shadow:var(--dsw-shadow-lv2);--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);border-radius:12px;flex-direction:column;display:flex;position:fixed;bottom:128px;left:12px;overflow:hidden}.zHeOwq_header{box-sizing:border-box;border-bottom:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-base);flex:none;justify-content:space-between;align-items:center;min-height:44px;padding:10px 12px;display:flex}.zHeOwq_body{flex:1;min-height:0;padding:4px 12px 12px;overflow-y:auto}.zHeOwq_title{color:var(--dsw-alias-label-primary);font-size:13px;font-weight:500;line-height:20px}.zHeOwq_note,.zHeOwq_readError{color:var(--dsw-alias-label-tertiary);margin:4px 0;font-size:12px;line-height:18px}.zHeOwq_readError{color:var(--dsw-alias-state-error-primary)}.zHeOwq_group{color:var(--dsw-alias-label-caption);text-transform:uppercase;letter-spacing:.04em;margin:8px 0 4px;font-size:11px;font-weight:500;line-height:16px}.zHeOwq_rows{flex-direction:column;gap:8px;margin:0;padding:0;list-style:none;display:flex}.zHeOwq_row{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-base);border-radius:12px;flex-direction:column;gap:8px;padding:10px 12px;display:flex}.zHeOwq_row[data-cordis-awaiting]{border-color:var(--dsw-alias-state-business-primary)}.zHeOwq_rowHead{align-items:center;gap:8px;display:flex}.zHeOwq_rowId{color:var(--dsw-alias-label-tertiary);font-family:var(--dsh-font-mono,monospace);flex:none;font-size:11px;line-height:20px}.zHeOwq_rowName{min-width:0;color:var(--dsw-alias-label-primary);text-overflow:ellipsis;white-space:nowrap;flex:1;font-size:13px;font-weight:500;line-height:20px;overflow:hidden}.zHeOwq_rowStatus{background:var(--dsw-alias-button-ghost-active-fill);height:20px;color:var(--dsw-alias-label-caption);border-radius:10px;flex:none;align-items:center;padding:0 6px;font-size:11px;line-height:20px;display:inline-flex}.zHeOwq_row[data-cordis-status=idle] .zHeOwq_rowStatus{background:var(--dsw-alias-button-ghost-active-fill);color:var(--dsw-alias-label-caption)}.zHeOwq_row[data-cordis-status=awaiting-approval] .zHeOwq_rowStatus,.zHeOwq_row[data-cordis-status=client-pending] .zHeOwq_rowStatus{background:var(--dsw-alias-state-warn-tertiary);color:var(--dsw-alias-state-warn-label)}.zHeOwq_row[data-cordis-status=failed] .zHeOwq_rowStatus{background:var(--dsw-alias-interactive-bg-hover-danger);color:var(--dsw-alias-state-error-primary)}.zHeOwq_row[data-cordis-status=running] .zHeOwq_rowStatus{background:var(--dsw-alias-state-success-tertiary);color:var(--dsw-alias-state-success-primary)}.zHeOwq_rowDetail{align-items:center;gap:8px;min-height:28px;display:flex}.zHeOwq_versionPicker{color:var(--dsw-alias-label-caption);align-items:center;gap:8px;font-size:11px;line-height:18px;display:flex}.zHeOwq_versionPicker select{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-base);min-width:0;height:26px;color:var(--dsw-alias-label-secondary);font:inherit;border-radius:7px;flex:1;padding:0 8px}.zHeOwq_rowPurpose{min-width:0;color:var(--dsw-alias-label-tertiary);text-overflow:ellipsis;white-space:nowrap;flex:1;font-size:12px;line-height:18px;overflow:hidden}.zHeOwq_rowError{color:var(--dsw-alias-state-error-primary);font-size:12px;line-height:18px}.zHeOwq_rowActions{flex:none;align-items:center;gap:10px;display:flex}.zHeOwq_transition{min-width:0;color:var(--dsw-alias-label-caption);align-items:center;gap:8px;font-size:11px;line-height:18px;display:flex}.zHeOwq_transitionActions{gap:6px;margin-left:auto;display:flex}.zHeOwq_transitionActions button{border:1px solid var(--dsw-alias-border-l2);color:var(--dsw-alias-label-secondary);font:inherit;cursor:pointer;background:0 0;border-radius:999px;padding:2px 8px}.zHeOwq_transitionActions button:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover)}.zHeOwq_transitionActions button:disabled{opacity:.4;cursor:default}.zHeOwq_activeVersion{color:var(--dsw-alias-label-caption);font-size:11px;line-height:16px}.zHeOwq_actionButton{width:28px;height:28px;color:var(--dsw-alias-label-tertiary);cursor:pointer;background:0 0;border:none;border-radius:999px;justify-content:center;align-items:center;padding:0;display:inline-flex}.zHeOwq_actionButton:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-secondary)}.zHeOwq_actionButton:disabled{opacity:.4;cursor:default}.zHeOwq_doubleCheck{width:17px;height:14px;display:inline-block;position:relative}.zHeOwq_doubleCheck svg{position:absolute;top:1px}.zHeOwq_doubleCheck svg:first-child{opacity:.7;left:0}.zHeOwq_doubleCheck svg:last-child{left:5px}";
		...
		var CordisPanel_module_css_default = {
			"rowStatus": "zHeOwq_rowStatus",
			"row": "zHeOwq_row",
			"rowPurpose": "zHeOwq_rowPurpose",
			"doubleCheck": "zHeOwq_doubleCheck",
			"title": "zHeOwq_title",
			"readError": "zHeOwq_readError",
			"rowError": "zHeOwq_rowError",
			"layer": "zHeOwq_layer",
			"rowDetail": "zHeOwq_rowDetail",
			"badgeLabel": "zHeOwq_badgeLabel",
			"note": "zHeOwq_note",
			"badgeCount": "zHeOwq_badgeCount",
			"rowId": "zHeOwq_rowId",
			"rowActions": "zHeOwq_rowActions",
			"group": "zHeOwq_group",
			"rowHead": "zHeOwq_rowHead",
			"body": "zHeOwq_body",
			"panel": "zHeOwq_panel",
			"activeVersion": "zHeOwq_activeVersion",
			"rows": "zHeOwq_rows",
			"actionButton": "zHeOwq_actionButton",
			"rail": "zHeOwq_rail",
			"badge": "zHeOwq_badge",
			"header": "zHeOwq_header",
			"rowName": "zHeOwq_rowName",
			"transition": "zHeOwq_transition",
			"transitionActions": "zHeOwq_transitionActions",
			"footerButtons": "zHeOwq_footerButtons",
			"versionPicker": "zHeOwq_versionPicker"
		};
		//#endregion
