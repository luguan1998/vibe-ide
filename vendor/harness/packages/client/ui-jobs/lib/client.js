window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		//#region \0dsh-css:E:\ai\deepseek-harness\packages\client\ui-jobs\src\client\JobListAction.module.css.mjs
		const css = ".eQPg5a_root{position:relative}.eQPg5a_trigger{min-height:28px;color:var(--dsw-alias-label-tertiary);cursor:pointer;background:0 0;border:0;border-radius:6px;align-items:center;gap:3px;padding:3px 2px;font-size:12px;line-height:18px;display:inline-flex}.eQPg5a_trigger:hover,.eQPg5a_trigger:focus-visible{color:var(--dsw-alias-label-secondary)}.eQPg5a_trigger svg{transition:transform .12s}.eQPg5a_triggerOpen{transform:rotate(180deg)}.eQPg5a_triggerDot{flex:none}.eQPg5a_count{margin:0 5px}.eQPg5a_menu{z-index:100;box-sizing:border-box;border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-specific-menu);--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);width:336px;max-width:min(400px,100vw - 32px);max-height:min(420px,100vh - 140px);box-shadow:var(--dsw-shadow-lv3);border-radius:12px;flex-direction:column;gap:1px;margin:0;padding:4px;list-style:none;display:flex;position:absolute;top:calc(100% + 5px);left:0;overflow:auto}.eQPg5a_row{box-sizing:border-box;width:100%;min-height:32px;color:var(--dsw-alias-label-primary);border-radius:8px;align-items:center;gap:8px;padding:6px 8px;font-size:13px;line-height:18px;display:flex}.eQPg5a_rowSettled{color:var(--dsw-alias-label-tertiary)}.eQPg5a_rowDot{flex:none}.eQPg5a_kind{background:var(--dsw-alias-fill-l2);color:var(--dsw-alias-label-secondary);border-radius:5px;flex:none;padding:0 6px;font-size:11px;line-height:18px}.eQPg5a_label{min-width:0;font-family:var(--dsw-font-mono);white-space:nowrap;text-overflow:ellipsis;flex:1;overflow:hidden}.eQPg5a_status,.eQPg5a_duration{color:var(--dsw-alias-label-tertiary);flex:none;font-size:11px;line-height:18px}.eQPg5a_status{white-space:nowrap;text-overflow:ellipsis;max-width:40%;overflow:hidden}.eQPg5a_duration{font-variant-numeric:tabular-nums}";
		...
		var JobListAction_module_css_default = {
			"triggerDot": "eQPg5a_triggerDot",
			"rowSettled": "eQPg5a_rowSettled",
			"menu": "eQPg5a_menu",
			"triggerOpen": "eQPg5a_triggerOpen",
			"rowDot": "eQPg5a_rowDot",
			"root": "eQPg5a_root",
			"count": "eQPg5a_count",
			"row": "eQPg5a_row",
			"kind": "eQPg5a_kind",
			"label": "eQPg5a_label",
			"status": "eQPg5a_status",
			"duration": "eQPg5a_duration",
			"trigger": "eQPg5a_trigger"
		};
		//#endregion
