window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		//#region \0dsh-css:E:\ai\deepseek-harness\packages\client\ui-subagent\src\client\SubagentCatalogAction.module.css.mjs
		const css$1 = ".tS7ePG_root{position:relative}.tS7ePG_trigger{min-height:28px;color:var(--dsw-alias-label-tertiary);cursor:pointer;background:0 0;border:0;border-radius:6px;align-items:center;gap:3px;padding:3px 2px;font-size:12px;line-height:18px;display:inline-flex}.tS7ePG_count{margin:0 5px}.tS7ePG_activitySlot{flex:none;width:10px;height:10px;display:inline-flex}.tS7ePG_trigger:hover,.tS7ePG_trigger:focus-visible{color:var(--dsw-alias-label-secondary)}.tS7ePG_trigger svg{transition:transform .12s}.tS7ePG_triggerOpen{transform:rotate(180deg)}.tS7ePG_menu{z-index:100;box-sizing:border-box;background:var(--dsw-specific-menu);--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);width:336px;max-width:min(400px,100vw - 32px);max-height:min(560px,100vh - 140px);box-shadow:var(--dsw-shadow-lv3);border-radius:12px;flex-direction:column;padding:4px;display:flex;position:absolute;top:calc(100% + 5px);left:0;overflow:auto}.tS7ePG_node{min-width:0;position:relative}.tS7ePG_menu>.tS7ePG_node{margin-left:-3px}.tS7ePG_row{box-sizing:border-box;width:100%;min-height:50px;color:var(--dsw-alias-label-primary);text-align:left;cursor:pointer;background:0 0;border:0;border-radius:8px;outline:none;align-items:flex-start;gap:8px;padding:7px 8px 7px 11px;font-size:13px;line-height:18px;display:flex;position:relative}.tS7ePG_row:hover>.tS7ePG_clickarea,.tS7ePG_row:focus-visible>.tS7ePG_clickarea{background:var(--dsw-alias-interactive-bg-hover)}.tS7ePG_clickarea{box-sizing:border-box;border-radius:8px;flex:1;align-self:stretch;align-items:flex-start;gap:8px;min-width:0;margin:-7px -8px;padding:7px 8px;display:flex}.tS7ePG_row>[data-state],.tS7ePG_clickarea>[data-state]{margin-top:4px}.tS7ePG_disabled{color:var(--dsw-alias-label-dimmed);cursor:not-allowed}.tS7ePG_disabled:hover{background:0 0}.tS7ePG_loadingRow{cursor:default}.tS7ePG_disclosure,.tS7ePG_disclosureSpace{flex:none;width:14px;height:18px}.tS7ePG_disclosure{color:var(--dsw-alias-label-tertiary);cursor:pointer;background:0 0;border:0;justify-content:center;align-items:center;padding:0;transition:transform .12s;display:inline-flex}.tS7ePG_disclosure:hover{color:var(--dsw-alias-label-primary)}.tS7ePG_disclosureOpen{transform:rotate(90deg)}.tS7ePG_content{flex-direction:column;flex:1;min-width:0;display:flex}.tS7ePG_label,.tS7ePG_summary{text-overflow:ellipsis;white-space:nowrap;overflow:hidden}.tS7ePG_label{color:inherit;font-weight:400}.tS7ePG_summary,.tS7ePG_metrics{color:var(--dsw-alias-label-tertiary);font-size:11px;line-height:16px}.tS7ePG_metrics{font-variant-numeric:tabular-nums;text-align:right;white-space:nowrap;flex:none;grid-template-rows:18px 16px;display:grid}.tS7ePG_metricToken{grid-row:1;line-height:18px}.tS7ePG_metricDuration{grid-row:2}.tS7ePG_children{margin-left:18px;padding-left:4px;position:relative}.tS7ePG_children:before,.tS7ePG_children>.tS7ePG_node:before{content:\"\";border-left:1px solid var(--dsw-alias-border-l2);position:absolute;left:0}.tS7ePG_children:before{height:26px;top:-26px}.tS7ePG_children[aria-busy=true]:before{content:none}.tS7ePG_children>.tS7ePG_node:before{top:0;bottom:0;left:-4px}.tS7ePG_children>.tS7ePG_node:last-child:before{height:17px;bottom:auto}.tS7ePG_children>.tS7ePG_node>.tS7ePG_row:before{content:\"\";border-top:1px solid var(--dsw-alias-border-l2);width:14px;position:absolute;top:16px;left:-4px}.tS7ePG_notice,.tS7ePG_error{color:var(--dsw-alias-label-tertiary);padding:10px 12px;font-size:12px;line-height:18px}.tS7ePG_error{color:var(--dsw-alias-state-error-primary);justify-content:space-between;align-items:center;gap:12px;display:flex}.tS7ePG_refresh{color:inherit;cursor:pointer;background:0 0;border:0;border-radius:6px;flex:none;align-items:center;gap:4px;padding:4px 6px;display:inline-flex}.tS7ePG_refresh:hover{background:var(--dsw-alias-interactive-bg-hover)}";
		...
		var SubagentCatalogAction_module_css_default = {
			"row": "tS7ePG_row",
			"root": "tS7ePG_root",
			"trigger": "tS7ePG_trigger",
			"summary": "tS7ePG_summary",
			"triggerOpen": "tS7ePG_triggerOpen",
			"menu": "tS7ePG_menu",
			"activitySlot": "tS7ePG_activitySlot",
			"disclosureSpace": "tS7ePG_disclosureSpace",
			"count": "tS7ePG_count",
			"clickarea": "tS7ePG_clickarea",
			"metrics": "tS7ePG_metrics",
			"metricToken": "tS7ePG_metricToken",
			"metricDuration": "tS7ePG_metricDuration",
			"disclosure": "tS7ePG_disclosure",
			"children": "tS7ePG_children",
			"error": "tS7ePG_error",
			"refresh": "tS7ePG_refresh",
			"label": "tS7ePG_label",
			"disabled": "tS7ePG_disabled",
			"disclosureOpen": "tS7ePG_disclosureOpen",
			"loadingRow": "tS7ePG_loadingRow",
			"node": "tS7ePG_node",
			"notice": "tS7ePG_notice",
			"content": "tS7ePG_content"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:E:\ai\deepseek-harness\packages\client\ui-subagent\src\client\SubagentReadOnlyComposer.module.css.mjs
		const css = ".eTfFsa_frame{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-1);min-height:54px;color:var(--dsw-alias-label-tertiary);border-radius:14px;justify-content:center;align-items:center;gap:8px;margin:0 24px 20px;padding:10px 16px;font-size:13px;line-height:20px;display:flex}.eTfFsa_frame strong{color:var(--dsw-alias-label-primary);font-weight:510}";
		...
		var SubagentReadOnlyComposer_module_css_default = { "frame": "eTfFsa_frame" };
		//#endregion
