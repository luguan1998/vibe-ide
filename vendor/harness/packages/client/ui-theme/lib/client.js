window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		//#endregion
		//#region \0dsh-css:E:\ai\deepseek-harness\packages\client\ui-theme\src\client\AppearanceRow.module.css.mjs
		const css = ".ml4evq_group{border-bottom:1px solid var(--dsw-alias-border-l2);flex-direction:column;gap:8px;padding:16px 0;display:flex}.ml4evq_title{color:var(--dsw-alias-label-primary);font-size:14px;font-weight:400;line-height:22px}.ml4evq_cubeRow{flex-wrap:wrap;align-items:stretch;gap:8px;display:flex}.ml4evq_themeCube{box-sizing:border-box;border:1px solid var(--dsw-alias-border-l2);font:inherit;color:var(--dsw-alias-label-primary);cursor:pointer;background:0 0;border-radius:16px;flex-direction:column;flex:180px;justify-content:center;align-items:center;gap:4px;padding:20px 32px;font-size:14px;line-height:22px;display:flex}.ml4evq_themeCube:hover:not(.ml4evq_selected){background:var(--dsw-alias-interactive-bg-hover)}.ml4evq_selected{background:var(--dsw-alias-bg-module-platform);border-color:var(--dsw-static-neutral-bluish-400)}";
		...
		var AppearanceRow_module_css_default = {
			"cubeRow": "ml4evq_cubeRow",
			"group": "ml4evq_group",
			"title": "ml4evq_title",
			"themeCube": "ml4evq_themeCube",
			"selected": "ml4evq_selected"
		};
		//#endregion
