window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:E:\ai\deepseek-harness\packages\client\ui-user-questions\src\client\PlanReviewPanel.module.css.mjs
		const css$1 = ".lodTJq_frame{padding:6px calc(var(--dsh-composer-side-clearance) + 16px) 10px;justify-content:center;display:flex}.lodTJq_card{width:100%;max-width:var(--dsh-chat-content-width);border:1px solid var(--dsw-alias-state-warn-secondary);background:var(--dsw-specific-input-major);max-height:min(60vh,520px);box-shadow:var(--dsw-shadow-lv2);color:var(--dsw-alias-label-primary);--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);border-radius:20px;flex-direction:column;display:flex;overflow:hidden}.lodTJq_card,.lodTJq_card *{box-sizing:border-box}.lodTJq_strip{background:var(--dsw-alias-state-warn-tertiary);color:var(--dsw-alias-state-warn-primary);flex-shrink:0;align-items:center;gap:8px;padding:10px 16px;font-size:13px;line-height:18px;display:flex}.lodTJq_dot{background:var(--dsw-alias-state-warn-primary);border-radius:50%;width:8px;height:8px}.lodTJq_body{overscroll-behavior:contain;flex:auto;min-height:0;padding:12px 16px 4px;font-size:14px;line-height:22px;overflow-y:auto}.lodTJq_footer{flex-shrink:0;justify-content:space-between;align-items:center;gap:12px;padding:8px 16px 12px;display:flex}.lodTJq_feedback{min-height:16px;color:var(--dsw-alias-state-error-primary);font-size:11px;line-height:16px}.lodTJq_actions{flex-shrink:0;align-items:center;gap:8px;display:flex}.lodTJq_discuss{color:var(--dsw-alias-label-secondary);gap:6px}.lodTJq_discuss:hover:not(:disabled){color:var(--dsw-alias-label-primary)}@media (width<=720px){.lodTJq_card{border-radius:16px}.lodTJq_body{padding:10px 12px 4px}.lodTJq_footer{align-items:flex-end;padding:8px 12px 10px}}";
		...
		var PlanReviewPanel_module_css_default = {
			"footer": "lodTJq_footer",
			"card": "lodTJq_card",
			"strip": "lodTJq_strip",
			"actions": "lodTJq_actions",
			"feedback": "lodTJq_feedback",
			"frame": "lodTJq_frame",
			"body": "lodTJq_body",
			"discuss": "lodTJq_discuss",
			"dot": "lodTJq_dot"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:E:\ai\deepseek-harness\packages\client\ui-user-questions\src\client\QuestionComposer.module.css.mjs
		const css = ".gyJuUG_frame{padding:6px calc(var(--dsh-composer-side-clearance) + 16px) 10px;justify-content:center;display:flex}.gyJuUG_card{width:100%;max-width:var(--dsh-chat-content-width);border:1px solid var(--dsw-alias-border-l2-darkmode-thin);background:var(--dsw-specific-input-major);max-height:min(60vh,520px);box-shadow:var(--dsw-shadow-lv2);color:var(--dsw-alias-label-primary);--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);border-radius:20px;flex-direction:column;padding:0 0 10px;display:flex;overflow:hidden}.gyJuUG_card,.gyJuUG_card *{box-sizing:border-box}.gyJuUG_header{flex-shrink:0;justify-content:space-between;align-items:flex-start;gap:16px;padding:20px 16px 0 24px;display:flex}.gyJuUG_headingBlock{min-width:0}.gyJuUG_eyebrow{color:var(--dsw-alias-label-tertiary);margin-bottom:5px;font-size:11px;line-height:16px}.gyJuUG_title{margin:0;font-size:16px;font-weight:500;line-height:22px}.gyJuUG_detail{margin:0 2px 8px}.gyJuUG_footerActions{flex-shrink:0;align-items:center;gap:12px;display:flex}.gyJuUG_pager{flex-shrink:0;align-items:center;gap:6px;display:flex}.gyJuUG_progress{color:var(--dsw-alias-label-secondary);white-space:nowrap;word-spacing:-2px;padding:0 4px;font-size:14px;font-weight:500;line-height:24px}.gyJuUG_iconButton{width:24px;height:24px;color:var(--dsw-alias-label-tertiary);cursor:pointer;background:0 0;border:none;border-radius:999px;place-items:center;padding:0;display:grid}.gyJuUG_iconButton:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-primary)}.gyJuUG_iconButton:disabled{color:var(--dsw-alias-label-dimmed);cursor:default}.gyJuUG_body{overscroll-behavior:contain;flex-direction:column;flex:auto;min-height:0;display:flex;overflow-y:auto}.gyJuUG_options{flex-direction:column;gap:1px;margin:8px 0 0;padding:4px 12px;display:flex}.gyJuUG_option{width:100%;min-height:40px;color:inherit;text-align:left;cursor:pointer;background:0 0;border:1px solid #0000;border-radius:12px;flex-shrink:0;align-items:flex-start;gap:8px;padding:8px 12px 8px 8px;transition:background-color .12s,border-color .12s;display:flex}.gyJuUG_option:hover:not(:disabled),.gyJuUG_optionSelected{background:var(--dsw-alias-interactive-bg-hover)}.gyJuUG_optionSelected{border-color:var(--dsw-alias-border-l2)}.gyJuUG_option:disabled{cursor:default}.gyJuUG_number{background:var(--dsw-alias-bg-overlay);width:20px;height:20px;color:var(--dsw-alias-label-secondary);border-radius:6px;flex:0 0 20px;place-items:center;margin-top:2px;font-size:12px;font-weight:500;line-height:18px;display:grid}.gyJuUG_checkbox{flex:0 0 20px;place-items:center;width:20px;height:20px;margin-top:2px;display:grid}.gyJuUG_checkbox:before{content:\"\";border:1px solid var(--dsw-alias-border-l4);border-radius:4px;grid-area:1/1;width:14px;height:14px;transition:background-color .12s,border-color .12s}.gyJuUG_checkbox>svg{grid-area:1/1}.gyJuUG_checkboxChecked{color:var(--dsw-alias-label-primary-foreground)}.gyJuUG_checkboxChecked:before{border-color:var(--dsw-alias-label-primary);background:var(--dsw-alias-label-primary)}.gyJuUG_optionCopy{flex:1;min-width:0}.gyJuUG_optionLine{flex-wrap:wrap;align-items:baseline;gap:2px 6px;display:flex}.gyJuUG_optionLabel{font-size:14px;font-weight:500;line-height:24px}.gyJuUG_badge{background:var(--dsw-specific-sidebar-nav-item-active-accent);color:var(--dsw-alias-button-info-fill);border-radius:6px;padding:0 4px;font-size:11px;font-weight:600;line-height:18px}.gyJuUG_description{color:var(--dsw-alias-label-tertiary);font-size:14px;font-weight:400;line-height:24px}.gyJuUG_customRow{border:1px solid #0000;border-radius:12px;flex-shrink:0;align-items:flex-start;gap:8px;width:100%;min-height:40px;padding:8px 12px 8px 8px;transition:background-color .12s,border-color .12s;display:flex}.gyJuUG_customRow:hover,.gyJuUG_customRow:focus-within,.gyJuUG_customRowActive{background:var(--dsw-alias-interactive-bg-hover)}.gyJuUG_customRow:focus-within,.gyJuUG_customRowActive{border-color:var(--dsw-alias-border-l2)}.gyJuUG_customInput{min-width:0;color:var(--dsw-alias-label-primary);caret-color:var(--dsw-alias-state-business-primary);font:inherit;background:0 0;border:none;outline:none;flex:1;padding:0;font-size:14px;line-height:24px}.gyJuUG_customInput::placeholder{color:var(--dsw-alias-label-caption)}.gyJuUG_customTextarea{resize:none;border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-module-platform);min-height:64px;max-height:140px;color:var(--dsw-alias-label-primary);caret-color:var(--dsw-alias-state-business-primary);font:inherit;border-radius:10px;outline:none;flex-shrink:0;margin:0 12px;padding:8px 12px;font-size:14px;line-height:24px;display:block}.gyJuUG_customTextarea:focus{border-color:var(--dsw-alias-state-business-primary)}.gyJuUG_customTextarea::placeholder{color:var(--dsw-alias-label-caption)}.gyJuUG_footer{flex-shrink:0;justify-content:space-between;align-items:center;gap:12px;margin-top:12px;padding:0 10px 0 18px;display:flex}.gyJuUG_feedback{min-height:16px;color:var(--dsw-alias-state-error-primary);text-align:right;flex:1;font-size:11px;line-height:16px}@media (width<=720px){.gyJuUG_card{border-radius:16px}.gyJuUG_header{padding:10px 12px 0 18px}.gyJuUG_options{padding:4px 8px}.gyJuUG_title{font-size:15px;line-height:21px}.gyJuUG_option,.gyJuUG_customRow{padding:8px 6px}.gyJuUG_footer{align-items:flex-end;padding:0 10px}.gyJuUG_footerActions{flex-shrink:0}}@media (prefers-reduced-motion:reduce){.gyJuUG_option,.gyJuUG_customRow{transition:none}}";
		...
		var QuestionComposer_module_css_default = {
			"optionLine": "gyJuUG_optionLine",
			"customTextarea": "gyJuUG_customTextarea",
			"body": "gyJuUG_body",
			"feedback": "gyJuUG_feedback",
			"card": "gyJuUG_card",
			"checkbox": "gyJuUG_checkbox",
			"progress": "gyJuUG_progress",
			"frame": "gyJuUG_frame",
			"customRow": "gyJuUG_customRow",
			"footerActions": "gyJuUG_footerActions",
			"eyebrow": "gyJuUG_eyebrow",
			"badge": "gyJuUG_badge",
			"title": "gyJuUG_title",
			"iconButton": "gyJuUG_iconButton",
			"customRowActive": "gyJuUG_customRowActive",
			"footer": "gyJuUG_footer",
			"option": "gyJuUG_option",
			"options": "gyJuUG_options",
			"headingBlock": "gyJuUG_headingBlock",
			"number": "gyJuUG_number",
			"checkboxChecked": "gyJuUG_checkboxChecked",
			"optionCopy": "gyJuUG_optionCopy",
			"optionLabel": "gyJuUG_optionLabel",
			"description": "gyJuUG_description",
			"customInput": "gyJuUG_customInput",
			"optionSelected": "gyJuUG_optionSelected",
			"header": "gyJuUG_header",
			"detail": "gyJuUG_detail",
			"pager": "gyJuUG_pager"
		};
		//#endregion
