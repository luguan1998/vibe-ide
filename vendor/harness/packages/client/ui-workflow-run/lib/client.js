window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		//#region \0dsh-css:E:\ai\deepseek-harness\packages\client\ui-workflow-run\src\client\WorkflowRunPanel.module.css.mjs
		const css = "._7gs5DG_root{width:100%;min-width:0}._7gs5DG_runHeader{box-sizing:border-box;background:var(--dsw-alias-bg-module-platform);border-radius:8px;align-items:center;gap:6px;width:100%;min-width:0;height:32px;padding:0 8px;display:flex}._7gs5DG_runHeader:focus-visible{outline:2px solid var(--dsw-alias-state-business-primary);outline-offset:-2px}._7gs5DG_runLeading{width:16px;height:16px;color:var(--dsw-alias-label-tertiary);flex:none;justify-content:center;align-items:center;margin-right:0;display:inline-flex}._7gs5DG_runTitle{max-width:42%;color:var(--dsw-alias-label-secondary);text-overflow:ellipsis;white-space:nowrap;flex:none;font-size:14px;font-weight:510;line-height:24px;overflow:hidden}._7gs5DG_runSummary{min-width:0;color:var(--dsw-alias-label-tertiary);text-overflow:ellipsis;white-space:nowrap;flex:1;font-size:12px;line-height:18px;overflow:hidden}._7gs5DG_statusTail{height:20px;color:var(--dsw-alias-label-secondary);white-space:nowrap;flex:none;align-items:center;gap:4px;font-size:11px;font-weight:510;line-height:16px;display:inline-flex;overflow:hidden}._7gs5DG_phaseHeader{box-sizing:border-box;align-items:center;gap:6px;width:100%;min-width:0;height:32px;display:flex}._7gs5DG_phaseHeader:focus-visible{outline:2px solid var(--dsw-alias-state-business-primary);outline-offset:-2px;border-radius:4px}._7gs5DG_phaseLeading{width:16px;height:16px;color:var(--dsw-alias-label-tertiary);flex:none;justify-content:center;align-items:center;margin-right:0;display:inline-flex}._7gs5DG_phaseTitle{min-width:0;max-width:42%;color:var(--dsw-alias-label-secondary);text-overflow:ellipsis;white-space:nowrap;flex:0 auto;font-size:14px;line-height:24px;overflow:hidden}._7gs5DG_phaseCount{min-width:0;color:var(--dsw-alias-label-tertiary);text-overflow:ellipsis;white-space:nowrap;flex:1;font-size:13px;line-height:20px;overflow:hidden}._7gs5DG_phaseStatus{width:132px;color:var(--dsw-alias-label-secondary);text-align:right;text-overflow:ellipsis;white-space:nowrap;flex:none;font-size:13px;line-height:20px;overflow:hidden}._7gs5DG_separator{background:var(--dsw-alias-label-tertiary);border-radius:50%;flex:none;width:2px;height:2px}._7gs5DG_phaseList{flex-direction:column;gap:4px;min-width:0;padding:4px 0 0 16px;display:flex}._7gs5DG_phase{min-width:0}._7gs5DG_members{flex-direction:column;gap:2px;min-width:0;padding:0 0 0 16px;display:flex}._7gs5DG_memberRow,._7gs5DG_memberButton{width:100%;min-width:0;min-height:24px;color:var(--dsw-alias-label-secondary);font:inherit;text-align:left;background:0 0;border:0;border-radius:4px;align-items:center;gap:12px;padding:0;display:flex}._7gs5DG_memberButton{cursor:pointer}._7gs5DG_memberButton ._7gs5DG_memberLabel{color:var(--dsw-alias-state-business-primary);text-underline-position:from-font;text-decoration:underline}._7gs5DG_dotSlot{flex:none;justify-content:center;align-items:center;width:16px;height:24px;display:inline-flex;overflow:hidden}._7gs5DG_memberButton:focus-visible{outline:none}._7gs5DG_memberButton:focus-visible ._7gs5DG_memberLabelWrap{outline:2px solid var(--dsw-alias-state-business-primary);outline-offset:-1px}._7gs5DG_memberLabelWrap{border-radius:4px;flex:1;align-items:center;min-width:0;height:24px;padding:0 2px;display:flex;overflow:hidden}._7gs5DG_memberLabel{min-width:0;color:var(--dsw-alias-label-secondary);text-overflow:ellipsis;white-space:nowrap;flex:1;font-size:14px;line-height:24px;overflow:hidden}._7gs5DG_memberStatus{width:64px;color:var(--dsw-alias-label-secondary);text-align:right;text-overflow:ellipsis;white-space:nowrap;flex:none;font-size:13px;line-height:20px;overflow:hidden}._7gs5DG_empty{color:var(--dsw-alias-label-tertiary);padding:0;font-size:13px;line-height:20px}@media (width<=560px){._7gs5DG_phaseList,._7gs5DG_members{padding-left:12px}}";
		...
		var WorkflowRunPanel_module_css_default = {
			"statusTail": "_7gs5DG_statusTail",
			"empty": "_7gs5DG_empty",
			"root": "_7gs5DG_root",
			"memberButton": "_7gs5DG_memberButton",
			"memberLabelWrap": "_7gs5DG_memberLabelWrap",
			"runSummary": "_7gs5DG_runSummary",
			"runTitle": "_7gs5DG_runTitle",
			"runLeading": "_7gs5DG_runLeading",
			"phaseList": "_7gs5DG_phaseList",
			"dotSlot": "_7gs5DG_dotSlot",
			"phaseStatus": "_7gs5DG_phaseStatus",
			"members": "_7gs5DG_members",
			"phaseLeading": "_7gs5DG_phaseLeading",
			"runHeader": "_7gs5DG_runHeader",
			"phaseTitle": "_7gs5DG_phaseTitle",
			"memberStatus": "_7gs5DG_memberStatus",
			"phaseCount": "_7gs5DG_phaseCount",
			"phase": "_7gs5DG_phase",
			"separator": "_7gs5DG_separator",
			"memberRow": "_7gs5DG_memberRow",
			"memberLabel": "_7gs5DG_memberLabel",
			"phaseHeader": "_7gs5DG_phaseHeader"
		};
		//#endregion
