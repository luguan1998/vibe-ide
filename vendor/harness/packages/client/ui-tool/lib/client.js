window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:E:\ai\deepseek-harness\packages\client\ui-tool\src\client\tool\components\ToolRow.module.css.mjs
		const css$3 = ".gC9eAq_root{flex-direction:column;display:flex}.gC9eAq_row{position:relative;overflow:hidden}.gC9eAq_root[data-state=running] .gC9eAq_row:after{content:\"\";background:linear-gradient(90deg, transparent 0%, color-mix(in srgb, var(--dsw-alias-bg-base) 60%, transparent) 55%, transparent 100%);pointer-events:none;width:300px;animation:2.6s ease-out infinite gC9eAq_dsh-tool-row-sweep;position:absolute;top:0;bottom:0;left:0}@keyframes gC9eAq_dsh-tool-row-sweep{0%{left:-300px}90%,to{left:100%}}.gC9eAq_leading{flex-shrink:0}.gC9eAq_root[data-tool^=cordis_] .gC9eAq_leading,.gC9eAq_root[data-tool^=cordis_] .gC9eAq_title{color:var(--dsw-alias-state-business-primary)}.gC9eAq_root[data-tool^=cordis_] .gC9eAq_title{font-weight:500}.gC9eAq_root[data-tool^=cordis_] .gC9eAq_sep{background:var(--dsw-alias-state-business-primary)}.gC9eAq_chevron{color:var(--dsw-alias-label-secondary)}.gC9eAq_title{font-weight:400}.gC9eAq_sep{background:var(--dsw-alias-label-caption);border-radius:1px;flex:none;width:2px;height:2px;margin:0 8px}.gC9eAq_summary{text-overflow:ellipsis;white-space:nowrap;min-width:0;color:var(--dsw-alias-label-tertiary);flex:auto;font-size:14px;line-height:24px;overflow:hidden}.gC9eAq_summarySuffix{white-space:nowrap;color:var(--dsw-alias-label-tertiary);flex:none;margin-left:4px;font-size:14px;line-height:24px}.gC9eAq_fileLink{text-overflow:ellipsis;white-space:nowrap;min-width:0;font:inherit;text-align:left;color:var(--dsw-alias-label-secondary);text-decoration:underline;text-decoration-color:var(--dsw-alias-label-quaternary);text-underline-offset:3px;cursor:pointer;background:0 0;border:none;flex:auto;margin:0;padding:0;font-size:14px;line-height:24px;overflow:hidden}.gC9eAq_fileLink:hover{color:var(--dsw-alias-label-primary);text-decoration-color:currentColor}.gC9eAq_errorSummary{color:var(--dsw-alias-state-error-primary)}.gC9eAq_bodyWrap{flex-direction:column;display:flex}.gC9eAq_inspectButton{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-base);color:var(--dsw-alias-label-secondary);cursor:pointer;opacity:0;border-radius:999px;align-self:flex-start;align-items:center;gap:4px;margin:4px 0 2px 4px;padding:2px 8px;font-size:11px;line-height:16px;transition:opacity .1s;display:inline-flex}.gC9eAq_root:hover .gC9eAq_inspectButton,.gC9eAq_inspectButton:focus-visible{opacity:1}.gC9eAq_inspectButton:hover{background:var(--dsw-alias-interactive-bg-hover-solid);color:var(--dsw-alias-label-primary)}.gC9eAq_bodyScroll{max-height:260px;overflow-y:auto}.gC9eAq_ioCard{border:1px solid var(--dsw-alias-border-l1);background:var(--dsw-alias-markdown-code-block);font:var(--dsw-font-markdown-code-block-small);border-radius:12px;flex-direction:column;margin:4px 0 4px 4px;display:flex}.gC9eAq_ioSection{grid-template-columns:max-content 1fr;align-items:baseline;column-gap:14px;max-height:150px;padding:12px 16px;display:grid;overflow-y:auto}.gC9eAq_ioSection::-webkit-scrollbar-thumb{background-clip:padding-box;border:2px solid #0000;border-radius:6px}.gC9eAq_ioSection::-webkit-scrollbar-track{margin:6px 0}.gC9eAq_ioLabel{color:var(--dsw-alias-label-caption);align-self:start;position:sticky;top:0}.gC9eAq_ioDivider{background:var(--dsw-alias-border-l2);flex:none;height:1px}.gC9eAq_ioText{white-space:pre-wrap;word-break:break-word;min-width:0;color:var(--dsw-alias-label-secondary)}.gC9eAq_ioText[data-error]{color:var(--dsw-alias-state-error-primary)}.gC9eAq_codeBody,.gC9eAq_terminalBody,.gC9eAq_diffBody,.gC9eAq_readBody,.gC9eAq_searchBody,.gC9eAq_webBody{margin:4px 0 4px 4px}.gC9eAq_searchRecovery{white-space:pre-wrap;overflow-wrap:anywhere;font:var(--dsw-font-xs-13);color:var(--dsw-alias-label-tertiary);margin:4px 0 4px 4px}.gC9eAq_codeBody{--dsl-code-block-content-font:var(--dsw-font-markdown-code-block-small)}.gC9eAq_terminalBody{--dsl-terminal-font:var(--dsw-font-markdown-code-block-small);--dsl-terminal-line-height:18px;--dsl-terminal-output-max-height:224px;border:1px solid var(--dsw-alias-border-l1)}.gC9eAq_visuallyHidden{clip:rect(0 0 0 0);white-space:nowrap;width:1px;height:1px;position:absolute;overflow:hidden}";
		...
		var ToolRow_module_css_default = {
			"title": "gC9eAq_title",
			"chevron": "gC9eAq_chevron",
			"ioCard": "gC9eAq_ioCard",
			"ioText": "gC9eAq_ioText",
			"leading": "gC9eAq_leading",
			"codeBody": "gC9eAq_codeBody",
			"sep": "gC9eAq_sep",
			"readBody": "gC9eAq_readBody",
			"webBody": "gC9eAq_webBody",
			"fileLink": "gC9eAq_fileLink",
			"summary": "gC9eAq_summary",
			"bodyWrap": "gC9eAq_bodyWrap",
			"terminalBody": "gC9eAq_terminalBody",
			"ioLabel": "gC9eAq_ioLabel",
			"ioDivider": "gC9eAq_ioDivider",
			"diffBody": "gC9eAq_diffBody",
			"root": "gC9eAq_root",
			"row": "gC9eAq_row",
			"inspectButton": "gC9eAq_inspectButton",
			"searchBody": "gC9eAq_searchBody",
			"searchRecovery": "gC9eAq_searchRecovery",
			"visuallyHidden": "gC9eAq_visuallyHidden",
			"bodyScroll": "gC9eAq_bodyScroll",
			"errorSummary": "gC9eAq_errorSummary",
			"ioSection": "gC9eAq_ioSection",
			"summarySuffix": "gC9eAq_summarySuffix",
			"dsh-tool-row-sweep": "gC9eAq_dsh-tool-row-sweep"
		};
		//#endregion
		...
		*  summary already describe a settled row). */
		...
		//#endregion
		//#region \0dsh-css:E:\ai\deepseek-harness\packages\client\ui-tool\src\client\tool\ToolCallTree.module.css.mjs
		const css$2 = ".FiDGIa_callRow{border-radius:6px}.FiDGIa_subCalls{border-left:1px solid var(--dsw-alias-border-l2);flex-direction:column;gap:4px;margin:4px 0 2px 22px;padding-left:8px;display:flex}";
		...
		var ToolCallTree_module_css_default = {
			"callRow": "FiDGIa_callRow",
			"subCalls": "FiDGIa_subCalls"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:E:\ai\deepseek-harness\packages\client\ui-tool\src\client\tool\ToolDetails.module.css.mjs
		const css$1 = ".r9k6GG_description{color:var(--dsw-alias-label-secondary);font:var(--dsw-font-xs-13);margin:0 0 6px}.r9k6GG_cardBody{margin:0}.r9k6GG_recovery{white-space:pre-wrap;overflow-wrap:anywhere;color:var(--dsw-alias-label-tertiary);font:var(--dsw-font-xs-13);margin:6px 0 0}.r9k6GG_code{background:var(--dsw-alias-markdown-code-block);font-family:var(--ds-font-family-code);color:var(--dsw-alias-label-primary);white-space:pre-wrap;word-break:break-word;border-radius:12px;margin:0;padding:16px;font-size:13px;line-height:22px}.r9k6GG_code[data-error]{color:var(--dsw-alias-state-error-primary)}.r9k6GG_read,.r9k6GG_web{margin:0}.r9k6GG_empty{color:var(--dsw-alias-label-tertiary);padding:8px 0;font-size:13px;line-height:20px}";
		...
		var ToolDetails_module_css_default = {
			...
			"code": "r9k6GG_code",
			"web": "r9k6GG_web",
			"description": "r9k6GG_description",
			"cardBody": "r9k6GG_cardBody",
			"empty": "r9k6GG_empty",
			"recovery": "r9k6GG_recovery"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:E:\ai\deepseek-harness\packages\client\ui-tool\src\client\tool\toolviews\bash-sample.module.css.mjs
		const css = ".q_py1a_card{flex-direction:column;display:flex}.q_py1a_terminal{--dsl-terminal-font:var(--dsw-font-markdown-code-block-small);--dsl-terminal-line-height:18px;--dsl-terminal-output-max-height:224px;border:1px solid var(--dsw-alias-border-l1);margin:4px 0 4px 4px}.q_py1a_ioCard{border:1px solid var(--dsw-alias-border-l1);background:var(--dsw-alias-markdown-code-block);font:var(--dsw-font-markdown-code-block-small);border-radius:12px;flex-direction:column;margin:4px 0 4px 4px;display:flex}.q_py1a_ioSection{grid-template-columns:max-content 1fr;align-items:baseline;column-gap:14px;max-height:150px;padding:12px 16px;display:grid;overflow-y:auto}.q_py1a_ioSection::-webkit-scrollbar-thumb{background-clip:padding-box;border:2px solid #0000;border-radius:6px}.q_py1a_ioSection::-webkit-scrollbar-track{margin:6px 0}.q_py1a_ioLabel{color:var(--dsw-alias-label-caption);align-self:start;position:sticky;top:0}.q_py1a_ioDivider{background:var(--dsw-alias-border-l2);flex:none;height:1px}.q_py1a_ioText{white-space:pre-wrap;word-break:break-word;min-width:0;color:var(--dsw-alias-label-secondary)}.q_py1a_ioText[data-error]{color:var(--dsw-alias-state-error-primary)}.q_py1a_root[data-expandable]{cursor:pointer}.q_py1a_root{align-items:center;min-width:0;height:24px;display:flex;position:relative;overflow:hidden}.q_py1a_root[data-state=running]:after{content:\"\";background:linear-gradient(90deg, transparent 0%, color-mix(in srgb, var(--dsw-alias-bg-base) 60%, transparent) 55%, transparent 100%);pointer-events:none;width:300px;animation:2.6s ease-out infinite q_py1a_dsh-bash-row-sweep;position:absolute;top:0;bottom:0;left:0}@keyframes q_py1a_dsh-bash-row-sweep{0%{left:-300px}90%,to{left:100%}}.q_py1a_leading{width:16px;height:16px;color:var(--dsw-alias-label-tertiary);flex:none;justify-content:center;align-items:center;margin-right:6px;display:inline-flex;position:relative}.q_py1a_chevron{color:var(--dsw-alias-label-secondary)}.q_py1a_iconIdle{opacity:1;transition:opacity .1s;display:inline-flex}.q_py1a_chevronHover{opacity:0;margin:auto;transition:opacity .1s;position:absolute;inset:0}.q_py1a_root:hover .q_py1a_iconIdle{opacity:0}.q_py1a_root:hover .q_py1a_chevronHover{opacity:1}.q_py1a_title{color:var(--dsw-alias-label-secondary);flex:none;font-size:14px;line-height:24px}.q_py1a_sep{background:var(--dsw-alias-label-caption);border-radius:1px;flex:none;width:2px;height:2px;margin:0 8px}.q_py1a_summary{text-overflow:ellipsis;white-space:nowrap;min-width:0;color:var(--dsw-alias-label-tertiary);flex:auto;font-size:14px;line-height:24px;overflow:hidden}.q_py1a_errorSummary{color:var(--dsw-alias-state-error-primary)}.q_py1a_bodyWrap{flex-direction:column;display:flex}.q_py1a_inspectButton{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-base);color:var(--dsw-alias-label-secondary);cursor:pointer;opacity:0;border-radius:999px;align-self:flex-start;align-items:center;gap:4px;margin:4px 0 2px 4px;padding:2px 8px;font-size:11px;line-height:16px;transition:opacity .1s;display:inline-flex}.q_py1a_card:hover .q_py1a_inspectButton,.q_py1a_inspectButton:focus-visible{opacity:1}.q_py1a_inspectButton:hover{background:var(--dsw-alias-interactive-bg-hover-solid);color:var(--dsw-alias-label-primary)}.q_py1a_visuallyHidden{clip:rect(0 0 0 0);white-space:nowrap;width:1px;height:1px;position:absolute;overflow:hidden}";
		...
		var bash_sample_module_css_default = {
			"chevronHover": "q_py1a_chevronHover",
			"chevron": "q_py1a_chevron",
			"ioSection": "q_py1a_ioSection",
			"title": "q_py1a_title",
			"sep": "q_py1a_sep",
			"root": "q_py1a_root",
			"errorSummary": "q_py1a_errorSummary",
			"inspectButton": "q_py1a_inspectButton",
			"visuallyHidden": "q_py1a_visuallyHidden",
			"ioDivider": "q_py1a_ioDivider",
			"ioCard": "q_py1a_ioCard",
			"card": "q_py1a_card",
			"terminal": "q_py1a_terminal",
			"leading": "q_py1a_leading",
			"dsh-bash-row-sweep": "q_py1a_dsh-bash-row-sweep",
			"summary": "q_py1a_summary",
			"ioText": "q_py1a_ioText",
			"bodyWrap": "q_py1a_bodyWrap",
			"iconIdle": "q_py1a_iconIdle",
			"ioLabel": "q_py1a_ioLabel"
		};
		//#endregion
