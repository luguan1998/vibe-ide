window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		//#region \0dsh-css:E:\ai\deepseek-harness\packages\client\ui-goal\src\client\GoalBar.module.css.mjs
		const css$1 = "._2GDaLG_dock{box-sizing:border-box;width:calc(100% - var(--dsh-composer-side-clearance) - var(--dsh-composer-side-clearance) - var(--dsh-composer-dock-inset) - var(--dsh-composer-dock-inset) - var(--dsh-composer-dock-inset) - var(--dsh-composer-dock-inset));margin:0 auto}._2GDaLG_bar{box-sizing:border-box;width:100%;max-width:calc(var(--dsh-composer-card-max-width) - 4 * var(--dsh-composer-dock-inset));border:1px solid var(--dsw-alias-border-l1);background:var(--dsw-specific-tip);border-radius:12px;align-items:center;gap:10px;height:36px;margin:0 auto;padding:4px 5px 4px 12px;display:flex}._2GDaLG_goalGlyph{color:var(--dsw-alias-label-tertiary);flex:none;display:inline-flex}._2GDaLG_label{color:var(--dsw-alias-label-primary);flex:none;font-size:13px;font-weight:500;line-height:24px}._2GDaLG_objective{min-width:0;color:var(--dsw-alias-label-primary-dimmed);text-overflow:ellipsis;white-space:nowrap;flex:1;font-size:13px;line-height:20px;overflow:hidden}._2GDaLG_error{min-width:0;color:var(--dsw-alias-state-error-primary);text-overflow:ellipsis;white-space:nowrap;flex:1;font-size:12px;line-height:20px;overflow:hidden}._2GDaLG_objectiveInput{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-base);min-width:0;height:26px;color:var(--dsw-alias-label-primary);border-radius:6px;outline:none;flex:1;padding:0 8px;font-size:13px;line-height:20px}._2GDaLG_objectiveInput:focus{border-color:var(--dsw-alias-state-business-primary)}._2GDaLG_objectiveInput::placeholder{color:var(--dsw-alias-label-caption)}._2GDaLG_actions{flex:none;align-items:center;gap:10px;display:flex}._2GDaLG_iconBtn{width:28px;height:28px;color:var(--dsw-alias-label-tertiary);cursor:pointer;background:0 0;border:none;border-radius:999px;justify-content:center;align-items:center;padding:0;display:inline-flex}._2GDaLG_iconBtn:hover{background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-secondary)}._2GDaLG_iconBtn:disabled{opacity:.4;cursor:default}";
		...
		var GoalBar_module_css_default = {
			"bar": "_2GDaLG_bar",
			"objective": "_2GDaLG_objective",
			"error": "_2GDaLG_error",
			"iconBtn": "_2GDaLG_iconBtn",
			"actions": "_2GDaLG_actions",
			"objectiveInput": "_2GDaLG_objectiveInput",
			"label": "_2GDaLG_label",
			"dock": "_2GDaLG_dock",
			"goalGlyph": "_2GDaLG_goalGlyph"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:E:\ai\deepseek-harness\packages\client\ui-goal\src\client\GoalCommandInputView.module.css.mjs
		const css = ".seLQIW_row{flex-direction:column;align-items:flex-end;gap:6px;display:flex}.seLQIW_stack{flex-direction:column;align-items:flex-end;min-width:0;max-width:min(525px,82%);display:flex}.seLQIW_bubble{overflow-wrap:anywhere;background:var(--dsw-specific-bubble);max-width:100%;color:var(--dsw-alias-label-primary);font:var(--dsw-font-markdown-code);white-space:pre-wrap;border-radius:22px;padding:10px 16px}";
