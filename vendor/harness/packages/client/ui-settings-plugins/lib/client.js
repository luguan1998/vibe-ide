window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		//#region \0dsh-css:E:\ai\deepseek-harness\packages\client\ui-settings-plugins\src\client\fields.module.css.mjs
		const css$2 = ".BhAgHq_field{flex-direction:column;gap:6px;padding:12px 0;display:flex}.BhAgHq_field+.BhAgHq_field{border-top:1px solid var(--dsw-alias-border-l2)}.BhAgHq_head{align-items:center;gap:8px;display:flex}.BhAgHq_label{min-width:0;color:var(--dsw-alias-label-primary);flex:1;font-size:13px;font-weight:500;line-height:1.5}.BhAgHq_badges{align-items:center;gap:8px;display:inline-flex}.BhAgHq_badge{white-space:nowrap;background:var(--dsw-alias-bg-module-platform);color:var(--dsw-alias-label-secondary);border-radius:999px;padding:1px 8px;font-size:11px;font-weight:500;line-height:17px}.BhAgHq_badgeMuted{white-space:nowrap;color:var(--dsw-alias-label-tertiary);border-radius:999px;padding:1px 8px;font-size:11px;line-height:17px}.BhAgHq_reset{font:inherit;color:var(--dsw-alias-label-secondary);cursor:pointer;background:0 0;border:none;padding:0;font-size:12px;line-height:1.5}.BhAgHq_reset:hover:not(:disabled){color:var(--dsw-alias-label-primary)}.BhAgHq_reset:disabled{cursor:default}.BhAgHq_input{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-3);height:34px;font:inherit;color:var(--dsw-alias-label-primary);border-radius:8px;padding:0 12px;font-size:13px;line-height:1.5}.BhAgHq_input:focus-visible{border-color:var(--dsw-alias-brand-primary);outline:none}.BhAgHq_input:disabled{color:var(--dsw-alias-label-tertiary);cursor:default}.BhAgHq_inputInvalid{border-color:var(--dsw-alias-label-error);}.BhAgHq_invalid{color:var(--dsw-alias-label-error);margin:0;font-size:12px;line-height:1.5}.BhAgHq_hint{color:var(--dsw-alias-label-tertiary);margin:0;font-size:12px;line-height:1.5}";
		...
		var fields_module_css_default = {
			"reset": "BhAgHq_reset",
			"badges": "BhAgHq_badges",
			"badge": "BhAgHq_badge",
			"field": "BhAgHq_field",
			"badgeMuted": "BhAgHq_badgeMuted",
			"label": "BhAgHq_label",
			"input": "BhAgHq_input",
			"inputInvalid": "BhAgHq_inputInvalid",
			"invalid": "BhAgHq_invalid",
			"hint": "BhAgHq_hint",
			"head": "BhAgHq_head"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:E:\ai\deepseek-harness\packages\client\ui-settings-plugins\src\client\PluginCard.module.css.mjs
		const css$1 = "._0jbxEq_card{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-3);border-radius:12px;list-style:none;transition:border-color .16s,background .16s}._0jbxEq_card:hover{border-color:var(--dsw-alias-label-dimmed)}._0jbxEq_cardOpen{background:var(--dsw-alias-bg-layer-2);border-color:var(--dsw-alias-label-dimmed)}._0jbxEq_header{appearance:none;width:100%;font:inherit;color:inherit;text-align:left;cursor:pointer;background:0 0;border:0;border-radius:12px;align-items:center;gap:12px;padding:14px 16px;display:flex}._0jbxEq_header:focus-visible{outline:2px solid var(--dsw-alias-brand-primary);outline-offset:-2px}._0jbxEq_headText{flex-direction:column;flex:1;gap:4px;min-width:0;display:flex}._0jbxEq_name{color:var(--dsw-alias-label-primary);font-size:15px;font-weight:600;line-height:1.4}._0jbxEq_description{color:var(--dsw-alias-label-tertiary);font-size:13px;line-height:1.5}._0jbxEq_chevron{color:var(--dsw-alias-label-tertiary);flex:none;transition:transform .16s}._0jbxEq_chevronOpen{transform:rotate(180deg)}._0jbxEq_body{border-top:1px solid var(--dsw-alias-border-l2);margin:0 16px;padding-bottom:8px}._0jbxEq_readOnly{color:var(--dsw-alias-label-tertiary);margin:12px 0 0;font-size:12px;line-height:1.5}._0jbxEq_pending{white-space:nowrap;background:var(--dsw-alias-bg-module-platform);color:var(--dsw-alias-label-secondary);border-radius:999px;flex:none;padding:1px 8px;font-size:11px;font-weight:500;line-height:17px}._0jbxEq_footer{border-top:1px solid var(--dsw-alias-border-l2);justify-content:flex-end;align-items:center;gap:8px;padding:12px 0 4px;display:flex}._0jbxEq_failed{min-width:0;color:var(--dsw-alias-label-error);flex:1;margin:0;font-size:12px;line-height:1.5}._0jbxEq_discard,._0jbxEq_save{appearance:none;font:inherit;cursor:pointer;border:1px solid #0000;border-radius:8px;padding:5px 14px;font-size:13px;line-height:1.5}._0jbxEq_discard{border-color:var(--dsw-alias-border-l2);color:var(--dsw-alias-label-secondary);background:0 0}._0jbxEq_discard:hover:not(:disabled){color:var(--dsw-alias-label-primary);border-color:var(--dsw-alias-label-dimmed)}._0jbxEq_save{background:var(--dsw-alias-label-primary);color:var(--dsw-alias-bg-layer-3)}._0jbxEq_discard:disabled,._0jbxEq_save:disabled{opacity:.4;cursor:default}._0jbxEq_discard:focus-visible,._0jbxEq_save:focus-visible{outline:2px solid var(--dsw-alias-brand-primary);outline-offset:1px}";
		...
		var PluginCard_module_css_default = {
			"readOnly": "_0jbxEq_readOnly",
			"header": "_0jbxEq_header",
			"discard": "_0jbxEq_discard",
			"name": "_0jbxEq_name",
			"failed": "_0jbxEq_failed",
			"footer": "_0jbxEq_footer",
			"chevronOpen": "_0jbxEq_chevronOpen",
			"pending": "_0jbxEq_pending",
			"cardOpen": "_0jbxEq_cardOpen",
			"chevron": "_0jbxEq_chevron",
			"save": "_0jbxEq_save",
			"description": "_0jbxEq_description",
			"card": "_0jbxEq_card",
			"headText": "_0jbxEq_headText",
			"body": "_0jbxEq_body"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:E:\ai\deepseek-harness\packages\client\ui-settings-plugins\src\client\PluginsSettingsSection.module.css.mjs
		const css = ".wi1RHa_section{max-width:760px;color:var(--dsw-alias-label-primary);flex-direction:column;gap:12px;display:flex}.wi1RHa_heading{margin:0;font-size:18px;font-weight:600}.wi1RHa_intro{color:var(--dsw-alias-label-tertiary);margin:0;font-size:13px}.wi1RHa_tabs{border-bottom:1px solid var(--dsw-alias-border-l2);align-items:flex-end;gap:22px;margin-top:2px;display:flex}.wi1RHa_tab{color:var(--dsw-alias-label-tertiary);font:inherit;cursor:pointer;background:0 0;border:0;padding:7px 1px 9px;font-size:13px;line-height:20px;position:relative}.wi1RHa_tab:hover,.wi1RHa_tab[data-active=true]{color:var(--dsw-alias-label-primary)}.wi1RHa_tab[data-active=true]:after,.wi1RHa_tab:focus-visible:after{background:var(--dsw-alias-label-primary);content:\"\";border-radius:2px 2px 0 0;height:2px;position:absolute;bottom:-1px;left:0;right:0}.wi1RHa_tab:focus-visible{outline:2px solid var(--dsw-alias-state-business-primary);outline-offset:2px;color:var(--dsw-alias-label-primary);border-radius:2px}.wi1RHa_panel{min-width:0;padding-top:2px}.wi1RHa_cards{flex-direction:column;gap:10px;margin:0;padding:0;list-style:none;display:flex}.wi1RHa_empty{color:var(--dsw-alias-label-tertiary);margin:0;font-size:13px}";
		...
		var PluginsSettingsSection_module_css_default = {
			"heading": "wi1RHa_heading",
			"empty": "wi1RHa_empty",
			"panel": "wi1RHa_panel",
			"cards": "wi1RHa_cards",
			"tabs": "wi1RHa_tabs",
			"section": "wi1RHa_section",
			"intro": "wi1RHa_intro",
			"tab": "wi1RHa_tab"
		};
		//#endregion
