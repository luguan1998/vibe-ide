window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		//#endregion
		//#region \0dsh-css:E:\ai\deepseek-harness\packages\client\ui-directory-picker-browse\src\client\DirectoryBrowser.module.css.mjs
		const css = ".DW2PZG_dialog.DW2PZG_dialog{--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);gap:0;width:min(680px,100%);height:min(500px,100dvh - 32px);padding:0}.DW2PZG_editorScope{display:contents}.DW2PZG_header{border-bottom:1px solid var(--dsw-alias-border-l3);flex-direction:column;flex:none;gap:8px;padding:16px 14px 8px 24px;display:flex}.DW2PZG_title{min-height:28px;color:var(--dsw-alias-label-primary);align-items:flex-end;margin:0;font-size:16px;font-weight:510;line-height:24px;display:flex}.DW2PZG_crumbBar{box-sizing:border-box;border:1px solid #0000;border-radius:8px;align-items:center;gap:4px;min-height:24px;margin-left:-9px;padding:0 8px;display:flex}.DW2PZG_crumbBar:has(.DW2PZG_crumbEditZone:enabled:hover),.DW2PZG_crumbBar:has(.DW2PZG_crumbEditZone:focus-visible),.DW2PZG_crumbBar:has(.DW2PZG_pathInput){border-color:var(--dsw-alias-border-l2)}.DW2PZG_millerRow{scrollbar-width:none;flex:1 1 0;align-items:stretch;gap:12px;min-height:0;display:flex;overflow-x:auto}.DW2PZG_crumbTrail{scrollbar-width:none;flex:0 auto;align-items:center;gap:4px;min-width:0;display:flex;overflow-x:auto}.DW2PZG_crumbSeat{flex:none;align-items:center;gap:4px;min-width:0;display:inline-flex}.DW2PZG_crumb{text-overflow:ellipsis;white-space:nowrap;max-width:160px;color:var(--dsw-alias-label-tertiary);cursor:pointer;background:0 0;border:none;padding:0;font-size:13px;font-weight:500;line-height:20px;overflow:hidden}.DW2PZG_crumb:hover{color:var(--dsw-alias-label-primary)}.DW2PZG_crumbChevron{color:var(--dsw-alias-label-tertiary);flex:none}.DW2PZG_crumbEditZone{cursor:text;background:0 0;border:none;outline:none;flex:1 0 34px;justify-content:flex-end;align-items:center;min-width:34px;height:22px;padding:0;display:flex}.DW2PZG_crumbEditGlyph{color:var(--dsw-alias-label-tertiary);flex:none}.DW2PZG_crumbEditZone:enabled:hover .DW2PZG_crumbEditGlyph,.DW2PZG_crumbEditZone:focus-visible .DW2PZG_crumbEditGlyph{color:var(--dsw-alias-label-primary)}.DW2PZG_crumbEditZone:disabled{cursor:default}.DW2PZG_crumbEditZone:disabled .DW2PZG_crumbEditGlyph{color:var(--dsw-alias-label-caption)}.DW2PZG_pathInput{box-sizing:border-box;min-width:0;height:22px;color:var(--dsw-alias-label-primary);background:0 0;border:none;outline:none;flex:1 1 0;padding:0;font-size:13px;line-height:20px}.DW2PZG_content{flex-direction:column;flex:1 1 0;min-height:0;padding:16px 16px 16px 24px;display:flex;position:relative}.DW2PZG_column{flex-direction:column;flex:1 1 0;gap:2px;min-width:256px;padding-right:8px;display:flex;overflow-y:auto}.DW2PZG_divider{background:var(--dsw-alias-border-l3);flex:none;width:1px}.DW2PZG_rowSeat{flex:none;display:flex}.DW2PZG_row{text-align:left;cursor:pointer;background:0 0;border:none;border-radius:6px;flex:none;align-items:center;gap:4px;width:100%;height:28px;padding:4px;display:flex}.DW2PZG_row:hover{background:var(--dsw-alias-interactive-bg-hover)}.DW2PZG_rowSelected,.DW2PZG_rowSelected:hover{background:var(--dsw-alias-interactive-bg-active,var(--dsw-alias-interactive-bg-hover))}.DW2PZG_rowIcon{color:var(--dsw-alias-label-secondary);flex:none}.DW2PZG_rowIconSelected{color:var(--dsw-alias-button-info-fill);flex:none}.DW2PZG_rowName{text-overflow:ellipsis;white-space:nowrap;min-width:0;color:var(--dsw-alias-label-primary);flex:1 1 0;font-size:13px;font-weight:500;line-height:20px;overflow:hidden}.DW2PZG_rowChevron{color:var(--dsw-alias-label-tertiary);flex:none}.DW2PZG_status,.DW2PZG_error{padding:4px 120px 4px 4px;font-size:12px;line-height:18px}.DW2PZG_status{color:var(--dsw-alias-label-secondary)}.DW2PZG_error{color:var(--dsw-alias-state-error-primary)}.DW2PZG_loadingFloat{background:var(--dsw-alias-bg-layer-2);padding:2px 8px;position:absolute;bottom:8px;right:16px}.DW2PZG_footerBar{border-top:1px solid var(--dsw-alias-border-l3);flex-wrap:wrap;flex:none;align-items:center;gap:8px;padding:16px 24px;display:flex}.DW2PZG_showHiddenToggle{color:var(--dsw-alias-label-secondary);cursor:pointer;white-space:nowrap;background:0 0;border:none;align-items:center;gap:4px;padding:0;font-size:13px;font-weight:500;line-height:20px;display:inline-flex}.DW2PZG_showHiddenToggle:hover{color:var(--dsw-alias-label-primary)}.DW2PZG_showHiddenToggle:disabled{color:var(--dsw-alias-label-caption);cursor:default}.DW2PZG_showHiddenToggleActive{color:var(--dsw-alias-label-primary)}.DW2PZG_footerGap{flex:1 1 0}.DW2PZG_footerAction{min-width:72px}.DW2PZG_createDialog.DW2PZG_createDialog{gap:0;width:min(380px,100%);padding:0}.DW2PZG_createBody{flex-direction:column;gap:12px;padding:22px 24px 20px;display:flex}.DW2PZG_createTitle{color:var(--dsw-alias-label-primary);margin:0;font-size:16px;font-weight:510;line-height:24px}.DW2PZG_createIn{color:var(--dsw-alias-label-primary);margin:0;font-size:14px;line-height:22px}.DW2PZG_createInput{box-sizing:border-box;border:1px solid var(--dsw-alias-border-l2);width:100%;height:44px;color:var(--dsw-alias-label-primary);background:0 0;border-radius:22px;outline:none;padding:7px 14px;font-size:14px;line-height:22px}.DW2PZG_createInput::placeholder{color:var(--dsw-alias-label-caption)}.DW2PZG_createActions{justify-content:flex-end;align-items:center;gap:8px;margin-top:8px;display:flex}";
		...
		var DirectoryBrowser_module_css_default = {
			"footerAction": "DW2PZG_footerAction",
			"header": "DW2PZG_header",
			"title": "DW2PZG_title",
			"content": "DW2PZG_content",
			"rowSeat": "DW2PZG_rowSeat",
			"dialog": "DW2PZG_dialog",
			"showHiddenToggle": "DW2PZG_showHiddenToggle",
			"createIn": "DW2PZG_createIn",
			"error": "DW2PZG_error",
			"createTitle": "DW2PZG_createTitle",
			"crumbBar": "DW2PZG_crumbBar",
			"crumbTrail": "DW2PZG_crumbTrail",
			"row": "DW2PZG_row",
			"rowName": "DW2PZG_rowName",
			"createDialog": "DW2PZG_createDialog",
			"column": "DW2PZG_column",
			"pathInput": "DW2PZG_pathInput",
			"loadingFloat": "DW2PZG_loadingFloat",
			"footerBar": "DW2PZG_footerBar",
			"footerGap": "DW2PZG_footerGap",
			"divider": "DW2PZG_divider",
			"editorScope": "DW2PZG_editorScope",
			"rowIconSelected": "DW2PZG_rowIconSelected",
			"rowIcon": "DW2PZG_rowIcon",
			"status": "DW2PZG_status",
			"rowChevron": "DW2PZG_rowChevron",
			"rowSelected": "DW2PZG_rowSelected",
			"crumbEditZone": "DW2PZG_crumbEditZone",
			"crumbChevron": "DW2PZG_crumbChevron",
			"crumbEditGlyph": "DW2PZG_crumbEditGlyph",
			"createInput": "DW2PZG_createInput",
			"createBody": "DW2PZG_createBody",
			"crumb": "DW2PZG_crumb",
			"crumbSeat": "DW2PZG_crumbSeat",
			"showHiddenToggleActive": "DW2PZG_showHiddenToggleActive",
			"createActions": "DW2PZG_createActions",
			"millerRow": "DW2PZG_millerRow"
		};
		//#endregion
