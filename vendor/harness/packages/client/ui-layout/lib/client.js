window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:E:\ai\deepseek-harness\packages\client\ui-layout\src\client\AppFrame.module.css.mjs
		const css = ".K43I8G_frame{background:var(--dsw-alias-bg-base);height:100%;transition:grid-template-columns var(--ds-transition-duration-slow) var(--ds-ease-in-out);grid-template-rows:100%;display:grid;position:relative;overflow:hidden}.K43I8G_frame[data-dragging]{transition:none}@media (prefers-reduced-motion:reduce){.K43I8G_frame{transition:none}}.K43I8G_sidebarCol{background:var(--dsw-specific-sidebar-fill);border-right:1px solid var(--dsw-alias-border-l1);min-width:0;overflow:hidden}.K43I8G_centerCol{flex-direction:column;min-width:0;display:flex;overflow:hidden}.K43I8G_detailsCol{border-left:1px solid var(--dsw-alias-border-l2);min-width:0;overflow:hidden}.K43I8G_frame[data-details-collapsed] .K43I8G_detailsCol{border-left:none}.K43I8G_handle{cursor:col-resize;z-index:2;touch-action:none;width:8px;transition:left var(--ds-transition-duration-slow) var(--ds-ease-in-out);margin-left:-4px;position:absolute;top:0;bottom:0}.K43I8G_frame[data-dragging] .K43I8G_handle{transition:none}@media (prefers-reduced-motion:reduce){.K43I8G_handle{transition:none}}.K43I8G_handle[data-side=details]:after{content:\"\";box-sizing:border-box;background:var(--dsw-alias-button-floating-fill);border:1px solid var(--dsw-alias-border-l2-darkmode-thin);opacity:0;width:12px;height:32px;transition:opacity var(--ds-transition-duration-slow) var(--ds-ease-in-out), background var(--ds-transition-duration-slow) var(--ds-ease-in-out);border-radius:10px;position:absolute;top:50%;left:50%;transform:translate(-50%,-50%)}.K43I8G_detailsCol:hover~.K43I8G_handle[data-side=details]:after,.K43I8G_handle[data-side=details]:hover:after,.K43I8G_handle[data-side=details][data-dragging=true]:after{opacity:1}.K43I8G_handle[data-side=details]:hover:after,.K43I8G_handle[data-side=details][data-dragging=true]:after{background:var(--dsw-alias-button-floating-hover);border-color:var(--dsw-alias-border-l3)}.K43I8G_overlayLayer{z-index:20;pointer-events:none;position:absolute;inset:0}.K43I8G_overlayLayer>*{pointer-events:auto}";
		...
		var AppFrame_module_css_default = {
			"centerCol": "K43I8G_centerCol",
			"handle": "K43I8G_handle",
			"detailsCol": "K43I8G_detailsCol",
			"frame": "K43I8G_frame",
			"overlayLayer": "K43I8G_overlayLayer",
			"sidebarCol": "K43I8G_sidebarCol"
		};
		//#endregion
