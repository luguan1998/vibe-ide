window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:E:\ai\deepseek-harness\packages\client\ui-agent-preset\src\client\AgentPresetRow.module.css.mjs
		const css$2 = ".Snv8za_row{border-bottom:1px solid var(--dsw-alias-border-l2);align-items:center;gap:8px;padding:16px 0;display:flex}.Snv8za_rowText{flex-direction:column;flex:1;gap:4px;min-width:0;padding-right:48px;display:flex}.Snv8za_title{color:var(--dsw-alias-label-primary);font-size:14px;font-weight:400;line-height:22px}.Snv8za_desc{color:var(--dsw-alias-label-tertiary);font-size:12px;font-weight:400;line-height:18px}.Snv8za_selector{background:var(--dsw-alias-bg-module-platform);height:36px;font:inherit;color:var(--dsw-alias-label-primary);cursor:pointer;border:none;border-radius:18px;align-items:center;gap:12px;padding:0 14px;font-size:14px;line-height:22px;display:inline-flex}.Snv8za_selector:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover)}.Snv8za_selector:disabled{cursor:default}.Snv8za_chevron{flex:none}";
		...
		var AgentPresetRow_module_css_default = {
			"selector": "Snv8za_selector",
			"title": "Snv8za_title",
			"row": "Snv8za_row",
			"desc": "Snv8za_desc",
			"chevron": "Snv8za_chevron",
			"rowText": "Snv8za_rowText"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:E:\ai\deepseek-harness\packages\client\ui-agent-preset\src\client\AgentPresetSeat.module.css.mjs
		const css$1 = ".-qUKLq_seat{max-width:min(100%,240px);min-height:28px;color:var(--dsw-alias-label-primary);white-space:nowrap;text-overflow:ellipsis;cursor:pointer;background:0 0;border:none;border-radius:16px;align-items:center;gap:4px;padding:0 8px;font-size:13px;font-weight:500;line-height:20px;display:inline-flex;overflow:hidden}.-qUKLq_seat:not(:disabled):hover,.-qUKLq_seat[aria-expanded=true]{background:var(--dsw-alias-interactive-bg-hover)}.-qUKLq_seat:disabled{cursor:default;color:var(--dsw-alias-label-quaternary)}.-qUKLq_seatIcon{color:var(--dsw-alias-label-primary);flex:none}.-qUKLq_introIcon{animation:.15s cubic-bezier(.16,1,.3,1) both -qUKLq_seat-icon-in}@keyframes -qUKLq_seat-icon-in{0%{opacity:0;transform:scale(.5)}to{opacity:1;transform:scale(1)}}.-qUKLq_introText{white-space:pre;display:inline-block}.-qUKLq_introChar{white-space:pre;opacity:0;animation:.4s ease-out forwards -qUKLq_seat-char-in;display:inline-block}@keyframes -qUKLq_seat-char-in{0%{opacity:0;transform:translateY(4px)}to{opacity:1;transform:none}}@media (prefers-reduced-motion:reduce){.-qUKLq_introIcon,.-qUKLq_introChar{opacity:1;animation:none}}.-qUKLq_chevron{color:var(--dsw-alias-label-caption);flex:none}.-qUKLq_item{flex-direction:column;gap:2px;max-width:280px;display:flex}.-qUKLq_itemName{color:var(--dsw-alias-label-primary);font-size:13px;line-height:20px}.-qUKLq_itemDesc{color:var(--dsw-alias-label-caption);white-space:normal;font-size:12px;line-height:16px}";
		...
		var AgentPresetSeat_module_css_default = {
			"item": "-qUKLq_item",
			"seat": "-qUKLq_seat",
			"itemDesc": "-qUKLq_itemDesc",
			"seatIcon": "-qUKLq_seatIcon",
			"introText": "-qUKLq_introText",
			"seat-char-in": "-qUKLq_seat-char-in",
			"itemName": "-qUKLq_itemName",
			"introIcon": "-qUKLq_introIcon",
			"introChar": "-qUKLq_introChar",
			"chevron": "-qUKLq_chevron",
			"seat-icon-in": "-qUKLq_seat-icon-in"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:E:\ai\deepseek-harness\packages\client\ui-agent-preset\src\client\AgentPresetSection.module.css.mjs
		const css = ".TREj7q_section{max-width:720px;color:var(--dsw-alias-label-primary);flex-direction:column;gap:12px;display:flex}.TREj7q_title{margin:0;font-size:18px;font-weight:600}.TREj7q_intro{color:var(--dsw-alias-label-tertiary);margin:0;font-size:13px}.TREj7q_group{flex-direction:column;gap:10px;display:flex}.TREj7q_group+.TREj7q_group{margin-top:20px}.TREj7q_groupHead{letter-spacing:.06em;text-transform:uppercase;color:var(--dsw-alias-label-tertiary);margin:0;font-size:12px;font-weight:600}.TREj7q_cards{grid-template-columns:repeat(auto-fill,minmax(268px,1fr));grid-auto-rows:1fr;gap:12px;margin:0;padding:0;list-style:none;display:grid}.TREj7q_card{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-3);border-radius:12px;flex-direction:column;transition:border-color .16s,background .16s;display:flex}.TREj7q_card:hover:not(.TREj7q_cardActive){border-color:var(--dsw-alias-label-dimmed)}.TREj7q_cardActive{background:var(--dsw-alias-bg-layer-2);border-color:var(--dsw-alias-label-primary)}.TREj7q_cardBroken,.TREj7q_cardBroken:hover{border-color:var(--dsw-alias-state-error-primary)}.TREj7q_brokenBadge{white-space:nowrap;background:var(--dsw-alias-state-error-primary);color:var(--dsw-alias-bg-layer-3);border-radius:999px;padding:1px 8px;font-size:11px;font-weight:500;line-height:17px}.TREj7q_cardBrokenReason{color:var(--dsw-alias-state-error-primary);overflow-wrap:anywhere;font-size:12px;line-height:1.5}.TREj7q_cardMain{appearance:none;font:inherit;color:inherit;text-align:left;cursor:pointer;background:0 0;border:0;border-radius:12px 12px 0 0;flex-direction:column;flex:1;gap:8px;padding:14px 16px 12px;display:flex}.TREj7q_cardMain:disabled{cursor:default}.TREj7q_cardMain:focus-visible{outline:2px solid var(--dsw-alias-brand-primary);outline-offset:-2px}.TREj7q_cardHead{align-items:center;gap:8px;display:flex}.TREj7q_cardName{font-size:15px;font-weight:600;line-height:1.4}.TREj7q_badge,.TREj7q_inUse{white-space:nowrap;border-radius:999px;padding:1px 8px;font-size:11px;font-weight:500;line-height:17px}.TREj7q_badge{border:1px solid var(--dsw-alias-border-l2);color:var(--dsw-alias-label-tertiary)}.TREj7q_inUse{background:var(--dsw-alias-label-primary);color:var(--dsw-alias-bg-layer-3);margin-left:auto}.TREj7q_cardDesc{color:var(--dsw-alias-label-secondary);-webkit-line-clamp:4;overflow-wrap:anywhere;-webkit-box-orient:vertical;min-height:42px;font-size:13px;line-height:1.55;display:-webkit-box;overflow:hidden}.TREj7q_cardId{font-family:var(--dsw-font-mono,ui-monospace, SFMono-Regular, Menlo, monospace);color:var(--dsw-alias-label-dimmed);margin-top:auto;font-size:11px}.TREj7q_cardFoot{border-top:1px solid var(--dsw-alias-border-l2);justify-content:flex-end;gap:2px;padding:6px 10px;display:flex}.TREj7q_iconButton{appearance:none;color:var(--dsw-alias-label-tertiary);cursor:pointer;background:0 0;border:0;border-radius:7px;align-items:center;padding:6px;display:inline-flex;position:relative}.TREj7q_iconButton:disabled{opacity:.4;cursor:default}.TREj7q_iconButton:hover:not(:disabled){background:var(--dsw-alias-bg-layer-1);color:var(--dsw-alias-label-primary)}.TREj7q_iconButton:focus-visible{outline:2px solid var(--dsw-alias-brand-primary);outline-offset:-1px}.TREj7q_iconButton:after{content:attr(data-tip);background:var(--dsw-alias-label-primary);color:var(--dsw-alias-bg-layer-3);white-space:nowrap;opacity:0;pointer-events:none;border-radius:6px;padding:3px 8px;font-size:11px;line-height:17px;transition:opacity .12s;position:absolute;bottom:calc(100% + 6px);left:50%;transform:translate(-50%)}.TREj7q_iconButton:hover:after,.TREj7q_iconButton:focus-visible:after{opacity:1}.TREj7q_iconDanger:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover-danger);color:var(--dsw-alias-state-error-primary)}.TREj7q_revealedPath{color:var(--dsw-alias-label-tertiary);align-items:baseline;gap:6px;margin:0;padding:6px 16px 10px;font-size:11px;display:flex}.TREj7q_revealedPath code{font-family:var(--dsw-font-mono,ui-monospace, SFMono-Regular, Menlo, monospace);color:var(--dsw-alias-label-secondary);user-select:all;overflow-wrap:anywhere}.TREj7q_revealedPathLabel{white-space:nowrap}.TREj7q_secondaryButton{color:var(--dsw-alias-label-secondary);font:inherit;cursor:pointer;background:0 0;border:none;border-radius:7px;padding:5px 8px;font-size:12.5px}.TREj7q_secondaryButton:hover:not(:disabled){background:var(--dsw-alias-bg-layer-1)}.TREj7q_secondaryButton:disabled{opacity:.5;cursor:default}.TREj7q_field{flex-direction:column;gap:6px;display:flex}.TREj7q_fieldLabel{color:var(--dsw-alias-label-secondary);font-size:12px;font-weight:500}.TREj7q_input{box-sizing:border-box;border:1px solid var(--dsw-alias-border-l2);font:inherit;background:var(--dsw-alias-bg-layer-1);color:var(--dsw-alias-label-primary);border-radius:10px;padding:9px 12px;font-size:13px}.TREj7q_input:focus{border-color:var(--dsw-alias-brand-primary);outline:none}.TREj7q_input::placeholder{color:var(--dsw-alias-label-dimmed)}.TREj7q_dialog{width:min(560px,100%)}.TREj7q_dialogFields{flex-direction:column;gap:12px;display:flex}.TREj7q_viewerCode{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-2);max-height:min(52vh,480px);color:var(--dsw-alias-label-secondary);font-family:var(--dsw-font-mono,ui-monospace, SFMono-Regular, Menlo, monospace);white-space:pre;tab-size:2;--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);border-radius:10px;margin:0;padding:12px;font-size:12.5px;line-height:1.5;overflow:auto}.TREj7q_error{color:var(--dsw-alias-state-error-primary);margin:0;font-size:12px}.TREj7q_deleteDialog{width:min(480px,100%)}.TREj7q_deleteConfirm:not(:disabled){border-color:var(--dsw-alias-state-error-primary);color:var(--dsw-alias-state-error-primary)}.TREj7q_deleteConfirm:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover-danger)}.TREj7q_creatorButton{box-sizing:border-box;border:1px dashed var(--dsw-alias-border-l3);height:44px;font:inherit;color:var(--dsw-alias-label-primary);cursor:pointer;background:0 0;border-radius:12px;justify-content:center;align-self:stretch;align-items:center;gap:6px;font-size:14px;line-height:22px;display:flex}.TREj7q_creatorButton:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover)}.TREj7q_creatorButton:disabled{opacity:.4;cursor:default}";
		...
		var AgentPresetSection_module_css_default = {
			"dialog": "TREj7q_dialog",
			"badge": "TREj7q_badge",
			"cardBrokenReason": "TREj7q_cardBrokenReason",
			"revealedPath": "TREj7q_revealedPath",
			"cardDesc": "TREj7q_cardDesc",
			"deleteConfirm": "TREj7q_deleteConfirm",
			"brokenBadge": "TREj7q_brokenBadge",
			"creatorButton": "TREj7q_creatorButton",
			"group": "TREj7q_group",
			"inUse": "TREj7q_inUse",
			"cardHead": "TREj7q_cardHead",
			"iconDanger": "TREj7q_iconDanger",
			"field": "TREj7q_field",
			"title": "TREj7q_title",
			"dialogFields": "TREj7q_dialogFields",
			"card": "TREj7q_card",
			"iconButton": "TREj7q_iconButton",
			"cardName": "TREj7q_cardName",
			"section": "TREj7q_section",
			"cardBroken": "TREj7q_cardBroken",
			"viewerCode": "TREj7q_viewerCode",
			"cardActive": "TREj7q_cardActive",
			"deleteDialog": "TREj7q_deleteDialog",
			"fieldLabel": "TREj7q_fieldLabel",
			"intro": "TREj7q_intro",
			"revealedPathLabel": "TREj7q_revealedPathLabel",
			"secondaryButton": "TREj7q_secondaryButton",
			"cardMain": "TREj7q_cardMain",
			"cardId": "TREj7q_cardId",
			"error": "TREj7q_error",
			"groupHead": "TREj7q_groupHead",
			"cards": "TREj7q_cards",
			"cardFoot": "TREj7q_cardFoot",
			"input": "TREj7q_input"
		};
		//#endregion
