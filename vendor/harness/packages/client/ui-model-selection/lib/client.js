window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:E:\ai\deepseek-harness\packages\client\ui-model-selection\src\client\ModelSelect.module.css.mjs
		const css = ".sJnW6q_root{min-width:0;position:relative}.sJnW6q_trigger{min-width:0;max-width:220px;height:28px;color:var(--dsw-alias-label-secondary);cursor:pointer;background:0 0;border:none;border-radius:24px;outline:none;align-items:center;gap:4px;padding:0 4px 0 8px;font-size:13px;font-weight:500;line-height:20px;display:flex}.sJnW6q_trigger:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover)}.sJnW6q_trigger:focus-visible{box-shadow:0 0 0 2px var(--dsw-alias-border-l3)}.sJnW6q_trigger:disabled{color:var(--dsw-alias-label-dimmed);cursor:default}.sJnW6q_triggerLabel{text-overflow:ellipsis;white-space:nowrap;min-width:0;overflow:hidden}.sJnW6q_triggerEffort{color:var(--dsw-alias-label-caption);flex:none}.sJnW6q_chevron{color:var(--dsw-alias-label-caption);flex:none;transition:transform .12s}.sJnW6q_chevronOpen{transform:rotate(180deg)}.sJnW6q_menu{z-index:20;border:1px solid var(--dsw-alias-border-inverted);background:var(--dsw-specific-menu);width:min(240px,100vw - 32px);max-height:min(360px,100vh - 96px);box-shadow:var(--dsw-shadow-lv3);color:var(--dsw-alias-label-primary);--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);border-radius:12px;flex-direction:column;padding:4px;display:flex;position:absolute;bottom:calc(100% + 8px);right:0;overflow:hidden}.sJnW6q_status,.sJnW6q_empty{color:var(--dsw-alias-label-tertiary);padding:10px;font-size:13px;line-height:20px}.sJnW6q_error,.sJnW6q_warning{background:var(--dsw-alias-interactive-bg-hover-danger);color:var(--dsw-alias-state-error-primary);border-radius:8px;justify-content:space-between;align-items:flex-start;gap:8px;margin-bottom:4px;padding:7px 8px;font-size:12px;line-height:18px;display:flex}.sJnW6q_warning{background:var(--dsw-alias-bg-module-platform);color:var(--dsw-alias-state-warn-label)}.sJnW6q_retry{color:inherit;font:inherit;cursor:pointer;background:0 0;border:none;flex:none;padding:0;font-weight:600}.sJnW6q_groups{min-height:0;overflow-y:auto}.sJnW6q_group+.sJnW6q_group{margin-top:4px}.sJnW6q_groupTitle{z-index:1;background:var(--dsw-specific-menu);color:var(--dsw-alias-label-tertiary);padding:5px 8px 3px;font-size:12px;font-weight:500;line-height:18px;position:sticky;top:0}.sJnW6q_option{width:100%;min-height:38px;color:inherit;text-align:left;cursor:pointer;background:0 0;border:none;border-radius:10px;outline:none;align-items:center;gap:8px;padding:6px 8px;display:flex}.sJnW6q_option:hover:not(:disabled),.sJnW6q_option:focus-visible{background:var(--dsw-alias-interactive-bg-hover)}.sJnW6q_selected{background:0 0}.sJnW6q_option:disabled{color:var(--dsw-alias-label-dimmed);cursor:default}.sJnW6q_optionCopy{flex-direction:column;flex:1;min-width:0;display:flex}.sJnW6q_modelName{color:inherit;text-overflow:ellipsis;white-space:nowrap;font-size:14px;font-weight:500;line-height:20px;overflow:hidden}.sJnW6q_description{color:var(--dsw-alias-label-tertiary);text-overflow:ellipsis;white-space:nowrap;font-size:12px;line-height:18px;overflow:hidden}.sJnW6q_check{color:var(--dsw-alias-label-primary);flex:0 0 18px;place-items:center;display:grid}.sJnW6q_cell{width:100%;height:40px;color:var(--dsw-alias-label-primary);cursor:pointer;text-align:left;background:0 0;border:none;border-radius:10px;align-items:center;gap:8px;padding:0 10px;font-size:14px;line-height:22px;display:flex}.sJnW6q_cell:hover{background:var(--dsw-alias-interactive-bg-hover)}.sJnW6q_cellLabel{text-overflow:ellipsis;white-space:nowrap;flex:auto;min-width:0;overflow:hidden}.sJnW6q_cellValue{text-overflow:ellipsis;white-space:nowrap;min-width:0;color:var(--dsw-alias-label-tertiary);flex:0 auto;overflow:hidden}.sJnW6q_cellChevron{color:var(--dsw-alias-label-tertiary);flex:none}";
		...
		var ModelSelect_module_css_default = {
			"group": "sJnW6q_group",
			"groupTitle": "sJnW6q_groupTitle",
			"retry": "sJnW6q_retry",
			"cellChevron": "sJnW6q_cellChevron",
			"chevron": "sJnW6q_chevron",
			"check": "sJnW6q_check",
			"empty": "sJnW6q_empty",
			"warning": "sJnW6q_warning",
			"triggerLabel": "sJnW6q_triggerLabel",
			"cell": "sJnW6q_cell",
			"chevronOpen": "sJnW6q_chevronOpen",
			"trigger": "sJnW6q_trigger",
			"menu": "sJnW6q_menu",
			"status": "sJnW6q_status",
			"selected": "sJnW6q_selected",
			"optionCopy": "sJnW6q_optionCopy",
			"root": "sJnW6q_root",
			"option": "sJnW6q_option",
			"description": "sJnW6q_description",
			"modelName": "sJnW6q_modelName",
			"cellLabel": "sJnW6q_cellLabel",
			"groups": "sJnW6q_groups",
			"triggerEffort": "sJnW6q_triggerEffort",
			"error": "sJnW6q_error",
			"cellValue": "sJnW6q_cellValue"
		};
		//#endregion
