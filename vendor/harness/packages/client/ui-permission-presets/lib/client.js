window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:E:\ai\deepseek-harness\packages\client\ui-permission-presets\src\client\PermissionRow.module.css.mjs
		const css = ".vDfYJa_row{border-bottom:1px solid var(--dsw-alias-border-l2);align-items:center;gap:8px;padding:16px 0;display:flex}.vDfYJa_rowText{flex-direction:column;flex:1;gap:4px;min-width:0;padding-right:48px;display:flex}.vDfYJa_title{color:var(--dsw-alias-label-primary);font-size:14px;font-weight:400;line-height:22px}.vDfYJa_desc{color:var(--dsw-alias-label-tertiary);font-size:12px;font-weight:400;line-height:18px}.vDfYJa_selector{background:var(--dsw-alias-bg-module-platform);height:36px;font:inherit;color:var(--dsw-alias-label-primary);cursor:pointer;border:none;border-radius:18px;align-items:center;gap:12px;padding:0 14px;font-size:14px;line-height:22px;display:inline-flex}.vDfYJa_selector:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover)}.vDfYJa_selector:disabled{cursor:default}.vDfYJa_chevron{flex:none}";
		...
		var PermissionRow_module_css_default = {
			"rowText": "vDfYJa_rowText",
			"desc": "vDfYJa_desc",
			"title": "vDfYJa_title",
			"row": "vDfYJa_row",
			"selector": "vDfYJa_selector",
			"chevron": "vDfYJa_chevron"
		};
		//#endregion
