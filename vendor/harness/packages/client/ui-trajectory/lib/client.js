window.__ModuleLoader__.load({
 ...
 /* istanbul ignore else */
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:E:\ai\deepseek-harness\packages\client\ui-trajectory\src\client\TrajectoryTable.module.css.mjs
		const css$3 = ".edxbaG_split{--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);background:var(--dsw-alias-bg-layer-1);flex:1;width:100%;min-height:0;display:flex;position:relative;overflow:hidden;container-type:inline-size}.edxbaG_tablePane{min-width:0;padding-bottom:var(--dsh-trajectory-bottom-clearance,0px);flex:1;position:relative;overflow:hidden auto;container:edxbaG_trajectory-table/inline-size}.edxbaG_historyLoading{z-index:5;pointer-events:none;height:0;position:sticky;top:0;overflow:visible}.edxbaG_historyLoadingBar{box-sizing:border-box;border-bottom:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-1);width:100%;height:30px;color:var(--dsw-alias-label-secondary);font:var(--dsw-font-xxs-12);justify-content:center;align-items:center;gap:6px;display:flex}.edxbaG_historyLoadingSpinner{box-sizing:border-box;border:1.5px solid var(--dsw-alias-border-l2);border-top-color:var(--dsw-alias-state-business-primary);border-radius:50%;width:10px;height:10px;animation:.7s linear infinite edxbaG_history-loading-spin}.edxbaG_table tbody .edxbaG_historyLoadRow td{height:30px;padding:0}.edxbaG_table tbody .edxbaG_historyLoadRow+tr[data-turn-start=true] td:before{content:none}.edxbaG_historyLoadButton{background:var(--dsw-alias-bg-layer-1);width:100%;height:29px;color:var(--dsw-alias-label-secondary);cursor:pointer;font:var(--dsw-font-xxs-12);border:0;justify-content:center;align-items:center;gap:6px;display:flex}.edxbaG_historyLoadButton:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-primary)}.edxbaG_historyLoadButton:focus-visible{outline:2px solid var(--dsw-alias-state-business-primary);outline-offset:-2px}.edxbaG_historyLoadButton:disabled{cursor:default}.edxbaG_visuallyHidden{clip:rect(0 0 0 0);white-space:nowrap;width:1px;height:1px;position:absolute;overflow:hidden}.edxbaG_table:not([data-scroll-ready=true]){visibility:hidden}@keyframes edxbaG_history-loading-spin{to{transform:rotate(360deg)}}@media (prefers-reduced-motion:reduce){.edxbaG_historyLoadingSpinner{animation:none}}.edxbaG_table{--trajectory-turn-accent:color-mix(in srgb, var(--dsw-static-blue-500) 22%, var(--dsw-alias-bg-layer-1));border-spacing:0;table-layout:fixed;width:100%;min-width:0;color:var(--dsw-alias-label-primary);background:var(--dsw-alias-bg-layer-1);font:var(--dsw-font-xxs-12)}.edxbaG_eventColumn{width:122px}.edxbaG_contentColumn{width:auto}.edxbaG_table th{z-index:3;box-sizing:border-box;border-bottom:1px solid var(--dsw-alias-border-l2);height:30px;color:var(--dsw-alias-label-tertiary);background:var(--dsw-specific-sidebar-fill);font:var(--dsw-font-xxs-12);text-align:left;text-overflow:ellipsis;user-select:none;white-space:nowrap;padding:0 8px;font-weight:500;position:sticky;top:0;overflow:hidden}.edxbaG_eventHeader{text-align:right!important;padding-right:4px!important}.edxbaG_table td{box-sizing:border-box;border-bottom:1px solid var(--dsw-alias-border-l1);text-overflow:ellipsis;white-space:nowrap;height:30px;padding:0 8px;overflow:hidden}.edxbaG_table tbody .edxbaG_virtualSpacer{pointer-events:none}.edxbaG_table tbody .edxbaG_virtualSpacer td{height:var(--trajectory-virtual-spacer-height);border:0;padding:0}.edxbaG_table tbody tr:not([data-collapsed-summary]):not([data-virtual-spacer]):not([data-history-load]){cursor:default;transition:background-color .12s var(--ds-ease-in-out), opacity .12s var(--ds-ease-in-out);outline:none}.edxbaG_table tbody tr[data-timeline-focus=outside]{opacity:.24}.edxbaG_table tbody tr:not([data-collapsed-summary]):not([data-virtual-spacer]):not([data-history-load]):not([data-selected=true]):hover{background:var(--dsw-alias-interactive-bg-hover)}.edxbaG_table tbody tr[data-request-only=true]:hover{background:0 0}.edxbaG_table tbody tr[data-request-only=true] td{border-bottom:0;height:0;padding-top:0;padding-bottom:0}.edxbaG_table tbody tr[data-terminal-request-boundary=true] td{height:9px}.edxbaG_table tbody tr[data-request-only=true] .edxbaG_turnRail{top:-15px;bottom:0}.edxbaG_table tbody tr:not([data-collapsed-summary]):focus-visible{box-shadow:inset 0 0 0 1px var(--dsw-alias-state-business-primary)}.edxbaG_table tbody tr[data-selected=true]{background:var(--dsw-alias-interactive-bg-active)}.edxbaG_requestBoundaryControl{--request-boundary-base-left:12px;z-index:6;top:-8px;left:calc(var(--request-boundary-base-left) + var(--request-boundary-offset,0px));cursor:pointer;background:0 0;border:0;width:16px;height:16px;padding:0;position:absolute}.edxbaG_requestBoundaryControl:before{background:var(--dsw-alias-label-caption);width:5px;height:5px;box-shadow:0 0 0 2px var(--dsw-alias-bg-layer-1), 0 0 0 3px transparent;content:\"\";transition:background .12s var(--ds-ease-in-out), box-shadow .12s var(--ds-ease-in-out);border-radius:50%;position:absolute;top:5.5px;left:5.5px}.edxbaG_requestBoundaryControl:after{border:1px solid var(--dsw-alias-border-l1);width:max-content;color:var(--dsw-alias-label-secondary);background:var(--dsw-alias-bg-layer-1);content:attr(data-label);font:9px/12px var(--ds-font-family-code);opacity:0;pointer-events:none;transition:opacity .12s var(--ds-ease-in-out), transform .12s var(--ds-ease-in-out);user-select:none;white-space:nowrap;border-radius:2px;padding:0 4px;position:absolute;top:2px;left:17px;transform:translate(-2px);box-shadow:0 2px 6px #0000001f}.edxbaG_requestBoundaryControl:hover:before,.edxbaG_requestBoundaryControl:focus-visible:before{background:var(--dsw-alias-brand-primary-new-colorprimary-new-color)}.edxbaG_requestBoundaryControlActive:before,.edxbaG_requestBoundaryControlActive:hover:before,.edxbaG_requestBoundaryControlActive:focus-visible:before{background:color-mix(in srgb, var(--dsw-alias-brand-primary-new-colorprimary-new-color) 18%, var(--dsw-alias-bg-layer-1));box-shadow:0 0 0 1.5px var(--dsw-alias-brand-primary-new-colorprimary-new-color)}.edxbaG_requestBoundaryControl[data-request-status=error]:before,.edxbaG_requestBoundaryControl[data-request-status=error]:hover:before,.edxbaG_requestBoundaryControl[data-request-status=error]:focus-visible:before{background:var(--dsw-alias-state-error-primary)}.edxbaG_requestBoundaryControl:hover:after,.edxbaG_requestBoundaryControl:focus-visible:after{opacity:1;transform:translate(0)}.edxbaG_requestBoundaryControl:focus-visible{outline:none}.edxbaG_table tbody tr:has(.edxbaG_requestBoundaryControl:hover):not([data-selected=true]){background:0 0}.edxbaG_event{position:relative}.edxbaG_turnRail,.edxbaG_selectionRail{background:var(--dsw-alias-brand-primary-new-colorprimary-new-color);pointer-events:none;position:absolute;left:0}.edxbaG_turnRail{z-index:4;background:var(--trajectory-turn-accent);width:2px;top:-1px;bottom:-1px}.edxbaG_table tbody tr[data-turn-end=true] .edxbaG_turnRail{bottom:0}.edxbaG_selectionRail{z-index:5;width:3px;top:0;bottom:0}.edxbaG_table tbody tr[data-error=true] .edxbaG_turnRail{background:color-mix(in srgb, var(--dsw-alias-state-error-primary) 22%, var(--dsw-alias-bg-layer-1))}.edxbaG_table tbody tr[data-error=true] .edxbaG_selectionRail{background:var(--dsw-alias-state-error-primary)}.edxbaG_table tbody tr[data-turn-start=true] td{position:relative;overflow:visible}.edxbaG_table tbody tr[data-turn-start=true]:not(:first-child) td:before{z-index:1;background:var(--dsw-alias-border-l1);content:\"\";pointer-events:none;height:2px;position:absolute;top:0;left:0;right:0;transform:translateY(-50%)}.edxbaG_event{padding-left:36px!important;padding-right:4px!important;overflow:visible!important}.edxbaG_turnLabel{z-index:3;box-sizing:border-box;width:max-content;color:var(--dsw-alias-label-tertiary);background:var(--dsw-alias-bg-module-platform);font:8px/10px var(--ds-font-family-code);font-variant-numeric:tabular-nums;user-select:none;white-space:nowrap;border-radius:0 0 2px;flex:none;align-items:center;padding:1px 5px;display:inline-grid;position:absolute;top:0;left:0}.edxbaG_turnLabelFull,.edxbaG_turnLabelCompact{opacity:1;white-space:nowrap;grid-area:1/1;max-width:64px;overflow:hidden}.edxbaG_turnLabelCompact{opacity:0;max-width:0}.edxbaG_turnLabelActive{color:color-mix(in srgb, var(--dsw-static-blue-500) 55%, var(--dsw-alias-label-tertiary));background:var(--trajectory-turn-accent)}.edxbaG_eventInner{justify-content:flex-start;align-items:center;min-width:0;height:100%;display:flex}.edxbaG_kindSlot{flex:none;justify-content:flex-end;align-items:flex-end;width:76px;display:flex}.edxbaG_kindSlot [role=tooltip]{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-2);box-shadow:var(--dsw-shadow-lv2);color:var(--dsw-alias-label-primary)}.edxbaG_content{color:var(--dsw-alias-label-primary);padding-left:4px!important}.edxbaG_kindTag{box-sizing:border-box;letter-spacing:.035em;user-select:none;border:1px solid #0000;border-radius:4px;flex:none;align-items:center;height:19px;padding:0 5px;font-size:10px;font-weight:650;line-height:16px;display:inline-flex}.edxbaG_kindTagIcon{opacity:0;flex:none;justify-content:center;align-items:center;width:0;height:13px;display:inline-flex;overflow:hidden;transform:scale(.8)}.edxbaG_kindTagLabel{opacity:1;white-space:nowrap;max-width:72px;display:inline-block;overflow:hidden}.edxbaG_table .edxbaG_kindSlot .edxbaG_message{justify-content:center;width:100%}@container edxbaG_trajectory-table (width<=620px){.edxbaG_eventColumn{width:50px}.edxbaG_event{padding-left:28px!important;padding-right:3px!important}.edxbaG_requestBoundaryControl{--request-boundary-base-left:6px}.edxbaG_kindSlot{width:19px}.edxbaG_kindTag,.edxbaG_table .edxbaG_kindSlot .edxbaG_message{justify-content:center;width:19px;padding-left:0;padding-right:0}.edxbaG_kindTagIcon{opacity:1;width:13px;transform:scale(1)}.edxbaG_kindTagLabel,.edxbaG_turnLabelFull{opacity:0;max-width:0}.edxbaG_turnLabelCompact{opacity:1;max-width:64px}}@media (prefers-reduced-motion:no-preference){.edxbaG_eventColumn,.edxbaG_event,.edxbaG_requestBoundaryControl,.edxbaG_kindSlot,.edxbaG_kindTag,.edxbaG_kindTagIcon,.edxbaG_kindTagLabel,.edxbaG_turnLabelFull,.edxbaG_turnLabelCompact{transition-duration:.18s;transition-timing-function:var(--ds-ease-in-out)}.edxbaG_eventColumn,.edxbaG_kindSlot{transition-property:width}.edxbaG_event{transition-property:padding-right,padding-left}.edxbaG_requestBoundaryControl{transition-property:left}.edxbaG_kindTag{transition-property:padding-right,padding-left}.edxbaG_kindTagIcon{transition-property:width,opacity,transform}.edxbaG_kindTagLabel,.edxbaG_turnLabelFull,.edxbaG_turnLabelCompact{transition-property:max-width,opacity}}.edxbaG_user{color:var(--dsw-alias-state-business-primary);background:var(--dsw-alias-state-business-tertiary)}.edxbaG_systemNeutral{color:var(--dsw-alias-label-secondary);background:var(--dsw-alias-bg-module-platform)}.edxbaG_contextGreen{color:color-mix(in srgb, var(--dsw-alias-state-success-primary) 68%, var(--dsw-alias-label-secondary));background:var(--dsw-alias-state-success-tertiary)}.edxbaG_compacted{color:var(--dsw-alias-label-secondary);background:var(--dsw-alias-bg-module-platform)}.edxbaG_compactedSummary{font:var(--dsw-font-xs-13);margin-top:12px;padding:0 0 14px}.edxbaG_promptDiffSections{flex-direction:column;gap:14px;max-height:100%;padding:10px 14px 14px;display:flex;overflow:auto}.edxbaG_promptDiffSection{min-width:0}.edxbaG_promptDiffTitle{color:var(--dsw-alias-label-secondary);font:var(--dsw-font-xs-strong-13);user-select:none;margin:0 0 6px}.edxbaG_promptDiff{color:var(--dsw-alias-label-primary);background:var(--dsw-alias-bg-layer-1);font:11px/17px var(--ds-font-family-code);white-space:pre;margin:0;overflow:auto}.edxbaG_promptDiff span{min-width:max-content;padding:0 6px;display:block}.edxbaG_promptDiffLinemeta{color:var(--dsw-alias-label-caption);background:var(--dsw-alias-bg-module-platform);user-select:none}.edxbaG_promptDiffLinecontext{color:var(--dsw-alias-label-secondary)}.edxbaG_promptDiffLineadded{color:color-mix(in srgb, var(--dsw-alias-state-success-primary) 72%, var(--dsw-alias-label-primary));background:var(--dsw-alias-state-success-tertiary)}.edxbaG_promptDiffLineremoved{color:var(--dsw-alias-state-error-primary);background:color-mix(in srgb, var(--dsw-alias-state-error-primary) 12%, var(--dsw-alias-bg-layer-1))}.edxbaG_assistantVioletBright{color:color-mix(in srgb, var(--dsw-alias-brand-primary-new-colorprimary-new-color) 60%, var(--dsw-alias-state-error-secondary));background:color-mix(in srgb, color-mix(in srgb, var(--dsw-alias-brand-primary-new-colorprimary-new-color) 55%, var(--dsw-alias-state-error-secondary)) 15%, var(--dsw-alias-bg-layer-1))}.edxbaG_toolAmber{color:var(--dsw-alias-state-warn-label);background:var(--dsw-alias-state-warn-tertiary)}.edxbaG_subtoolAmber{color:color-mix(in srgb, var(--dsw-alias-state-warn-label) 62%, var(--dsw-alias-label-tertiary));background:color-mix(in srgb, var(--dsw-alias-state-warn-tertiary) 58%, var(--dsw-alias-bg-layer-1))}.edxbaG_contentText{text-overflow:ellipsis;white-space:nowrap;min-width:0;display:block;overflow:hidden}.edxbaG_toolCallOnly{color:var(--dsw-alias-label-tertiary)}.edxbaG_table tbody tr[data-collapsed-summary=turn] td,.edxbaG_table tbody tr[data-collapsed-summary=assistant] td{height:20px}.edxbaG_table tbody tr[data-collapsed-summary]{cursor:pointer;transition:background-color .12s var(--ds-ease-in-out);outline:none}.edxbaG_table tbody tr[data-collapsed-summary]:hover{background:var(--dsw-alias-interactive-bg-hover)}.edxbaG_table tbody tr[data-collapsed-summary]:focus-visible{box-shadow:inset 0 0 0 1px var(--dsw-alias-state-business-primary)}.edxbaG_collapsedTurnContent{min-width:0;color:var(--dsw-alias-label-secondary);align-items:center;font-size:12px;line-height:16px;display:flex}.edxbaG_collapsedTurnEllipsis{color:var(--dsw-alias-label-tertiary);user-select:none;flex:none;margin-right:6px;font-weight:600}.edxbaG_collapsedTurnText{text-overflow:ellipsis;white-space:nowrap;min-width:0;overflow:hidden}.edxbaG_resultPreview{grid-template-columns:clamp(180px, var(--trajectory-tool-request-width,calc(36cqw - 56px)), 480px) minmax(0, 1fr);align-items:center;gap:8px;min-width:0;display:grid}.edxbaG_resultRequest,.edxbaG_inlineResultText{text-overflow:ellipsis;white-space:nowrap;min-width:0;overflow:hidden}.edxbaG_toolCallNameTypeface{color:var(--dsw-alias-label-primary);font:400 12px/18px Menlo,Consolas,Liberation Mono,PingFang SC,Microsoft YaHei}.edxbaG_toolCallPayload{color:var(--dsw-alias-label-secondary);font:400 12px/18px var(--ds-font-family-code);margin-left:7px}.edxbaG_table tbody tr[data-kind=tool] .edxbaG_contentText,.edxbaG_table tbody tr[data-kind=subtool] .edxbaG_contentText,.edxbaG_table tbody tr[data-kind=tool] .edxbaG_resultPreview,.edxbaG_table tbody tr[data-kind=subtool] .edxbaG_resultPreview{font-family:var(--ds-font-family-code);font-size:12px}.edxbaG_table tbody tr[data-kind=subtool] .edxbaG_content{padding-left:26px}.edxbaG_inlineResult{min-width:0;color:var(--dsw-alias-label-secondary);align-items:center;display:flex}.edxbaG_noOutputText{color:var(--dsw-alias-label-caption)}.edxbaG_arrow{color:var(--dsw-alias-label-caption);flex:none;margin-right:8px}.edxbaG_error,.edxbaG_overview dd.edxbaG_error,.edxbaG_details .edxbaG_errorPayload{color:var(--dsw-alias-state-error-primary)}.edxbaG_details .edxbaG_errorPayload .edxbaG_resultBlockText{color:inherit}.edxbaG_details .edxbaG_jsonPayload.edxbaG_errorPayload,.edxbaG_details .edxbaG_jsonPreview.edxbaG_errorPayload{--json-tree-property:var(--dsw-alias-state-error-primary);--json-tree-string:var(--dsw-alias-state-error-primary);--json-tree-number:var(--dsw-alias-state-error-primary);--json-tree-keyword:var(--dsw-alias-state-error-primary);--json-tree-punctuation:var(--dsw-alias-state-error-primary);--json-tree-icon:var(--dsw-alias-state-error-primary)}.edxbaG_details{border-left:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-1);flex-direction:column;flex:none;width:clamp(320px,38%,440px);min-width:0;max-width:calc(100% - 280px);min-height:0;display:flex;position:relative}.edxbaG_detailsResizeHandle{z-index:6;cursor:col-resize;touch-action:none;user-select:none;background:0 0;border:0;width:8px;padding:0;position:absolute;top:0;bottom:0;left:-4px}.edxbaG_detailsResizeHandle:focus-visible{outline:none}.edxbaG_detailsHeader{box-sizing:border-box;border-bottom:1px solid var(--dsw-alias-border-l2);flex:none;justify-content:space-between;align-items:center;height:42px;padding:0 8px 0 12px;display:flex}.edxbaG_detailsTitle{min-width:0;color:var(--dsw-alias-label-primary);align-items:center;gap:8px;display:flex}.edxbaG_requestDetailsDot{background:var(--dsw-alias-label-secondary);border-radius:50%;flex:none;width:5px;height:5px}.edxbaG_requestDetailsName{font:500 12px/16px var(--ds-font-family-code);flex:none}.edxbaG_detailsLocation{min-width:0;color:var(--dsw-alias-label-tertiary);font:11px/16px var(--ds-font-family-code);text-overflow:ellipsis;white-space:nowrap;overflow:hidden}.edxbaG_close{width:28px;height:28px;color:var(--dsw-alias-label-secondary);cursor:pointer;background:0 0;border:0;border-radius:6px;flex:none;justify-content:center;align-items:center;padding:0;font-size:18px;line-height:18px;display:inline-flex}.edxbaG_close:hover{color:var(--dsw-alias-label-primary);background:var(--dsw-alias-interactive-bg-hover)}.edxbaG_detailTabs{box-sizing:border-box;border-bottom:1px solid var(--dsw-alias-border-l2);overscroll-behavior-x:contain;scrollbar-width:none;white-space:nowrap;flex:none;gap:1px;width:100%;min-width:0;max-width:100%;height:34px;padding:0 8px;display:flex;overflow:auto hidden}.edxbaG_detailTabs::-webkit-scrollbar{display:none}.edxbaG_detailTab{color:var(--dsw-alias-label-tertiary);cursor:pointer;font:var(--dsw-font-xs-13);background:0 0;border:0;flex:none;padding:0 9px;position:relative}.edxbaG_detailTab:hover{color:var(--dsw-alias-label-primary);background:var(--dsw-alias-interactive-bg-hover)}.edxbaG_detailTabActive{color:var(--dsw-alias-state-business-primary)}.edxbaG_detailTabActive:after{background:var(--dsw-alias-state-business-primary);content:\"\";border-radius:1px 1px 0 0;height:2px;position:absolute;bottom:0;left:9px;right:9px}.edxbaG_close:focus-visible,.edxbaG_detailTab:focus-visible{outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:-1px}.edxbaG_detailBody{min-height:0;padding-bottom:var(--dsh-trajectory-bottom-clearance,0px);scrollbar-gutter:stable;flex:1;overflow:hidden auto}.edxbaG_detailBodySummary{box-sizing:border-box;padding-bottom:calc(12px + var(--dsh-trajectory-bottom-clearance,0px));flex-direction:column;display:flex;overflow:hidden}.edxbaG_detailBodySummary>.edxbaG_overview{overscroll-behavior:contain;flex:0 auto;min-height:0;overflow:auto}.edxbaG_detailBodySummary>.edxbaG_compactedSummary{flex:1;min-height:0;overflow:auto}.edxbaG_summaryScrollRegion{--dsh-scrollbar-thumb:transparent;--dsh-scrollbar-thumb-hover:transparent}.edxbaG_summaryScrollRegion:hover,.edxbaG_summaryScrollRegion:focus-within{--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2)}.edxbaG_compactedSummary .edxbaG_markdownPayload{padding-right:18px}.edxbaG_overview{font:var(--dsw-font-xs-13);margin:0;padding:8px 0}.edxbaG_overviewParentLinks{gap:14px;display:flex}.edxbaG_overviewHierarchyNavLink{all:unset;color:var(--dsw-alias-label-secondary);cursor:pointer;font:inherit;opacity:1;align-items:center;gap:1px;display:inline-flex}.edxbaG_overviewHierarchyNavLink:hover{color:var(--dsw-alias-label-primary)}.edxbaG_overviewHierarchyJumpIconTight{color:var(--dsw-alias-label-caption);flex:none}.edxbaG_overviewHierarchyNavLink:hover .edxbaG_overviewHierarchyJumpIconTight,.edxbaG_overviewHierarchyNavLink:focus-visible .edxbaG_overviewHierarchyJumpIconTight{color:var(--dsw-alias-label-primary)}.edxbaG_overviewHierarchyNavLink:focus-visible{color:var(--dsw-alias-label-primary);outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:2px}.edxbaG_overview>div{grid-template-columns:94px minmax(0,1fr);align-items:center;min-height:22px;padding:0 14px;display:grid}.edxbaG_overview>.edxbaG_requestTokenDetail dt{padding-left:12px}.edxbaG_usagePanel{padding:4px 0 10px}.edxbaG_usageGroup+.edxbaG_usageGroup{margin-top:8px}.edxbaG_usageHeading{color:var(--dsw-alias-label-secondary);font:var(--dsw-font-xs-strong-13);user-select:none;margin:0;padding:4px 14px 1px}.edxbaG_usageGroup .edxbaG_overview{padding:0}.edxbaG_overview dt{color:var(--dsw-alias-label-tertiary)}.edxbaG_overview dd{min-width:0;color:var(--dsw-alias-label-primary);text-overflow:ellipsis;white-space:nowrap;margin:0;overflow:hidden}.edxbaG_timestampToggle{all:unset;color:inherit;cursor:pointer;font:inherit;user-select:text}.edxbaG_timestampToggle:focus-visible{outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:2px}.edxbaG_overviewSections{border-top:0;flex-direction:column;flex:1;min-height:min-content;display:flex;overflow:hidden}.edxbaG_overviewSection{flex-direction:column;flex:1 1 0;min-height:28px;max-height:max-content;display:flex;overflow:hidden}.edxbaG_overviewSection+.edxbaG_overviewSection{padding-top:8px}.edxbaG_overviewHeading{box-sizing:border-box;width:100%;height:28px;color:var(--dsw-alias-label-secondary);background:var(--dsw-alias-bg-layer-1);font:var(--dsw-font-xs-strong-13);user-select:none;flex:none;align-items:flex-end;margin:0;padding:0 0 3px 14px;display:flex}.edxbaG_overviewTitle{width:max-content;height:auto;color:inherit;cursor:pointer;font:inherit;user-select:none;background:0 0;border:0;flex:none;align-items:center;gap:3px;padding:0;line-height:1;display:inline-flex}.edxbaG_overviewTitleIcon{color:var(--dsw-alias-label-caption);flex:none}.edxbaG_overviewTitle:hover .edxbaG_overviewTitleIcon{color:var(--dsw-alias-label-primary)}.edxbaG_overviewTitle:focus-visible{outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:2px}.edxbaG_overviewTitle:focus-visible .edxbaG_overviewTitleIcon{color:var(--dsw-alias-state-business-primary)}.edxbaG_overviewPreview{overscroll-behavior:contain;background:var(--dsw-alias-bg-layer-1);flex:1;min-height:0;overflow:auto}.edxbaG_overviewPreview>:last-child{margin-bottom:0;padding-bottom:0}.edxbaG_overviewPreview .edxbaG_jsonPreview>:first-child,.edxbaG_overviewPreview .edxbaG_schemaTree>:first-child{padding-bottom:0}.edxbaG_overviewPreview .edxbaG_schemaTree{margin-bottom:0}.edxbaG_overviewPreview .edxbaG_overview{padding:2px 0 0}.edxbaG_overviewPreview .edxbaG_overview>div{min-height:22px}.edxbaG_markdownPreview,.edxbaG_markdownPayload{color:var(--dsw-alias-label-primary)}.edxbaG_markdownPreview>div,.edxbaG_markdownPayload>div{font:var(--dsw-font-xs-13);gap:8px}.edxbaG_markdownPreview>div h1,.edxbaG_markdownPayload>div h1{font:600 16px/22px var(--dsw-font-family)}.edxbaG_markdownPreview>div h2,.edxbaG_markdownPayload>div h2{font:600 15px/22px var(--dsw-font-family)}.edxbaG_markdownPreview>div :where(h3,h4,h5,h6),.edxbaG_markdownPayload>div :where(h3,h4,h5,h6){font:600 14px/20px var(--dsw-font-family)}.edxbaG_markdownPreview>div :not(pre)>code,.edxbaG_markdownPayload>div :not(pre)>code{font:12px/18px var(--ds-font-family-code)}.edxbaG_markdownPreview>div table,.edxbaG_markdownPayload>div table{font:var(--dsw-font-xs-13)}.edxbaG_markdownPreview>div>:first-child{margin-top:0}.edxbaG_markdownPreview>div>:last-child{margin-bottom:0}.edxbaG_markdownPreview>div :where(h1,h2,h3){margin:12px 0 6px}.edxbaG_markdownPreview>div :where(h4,h5,h6){margin:10px 0 5px}.edxbaG_markdownPreview>div :where(p,ul,ol){margin:8px 0}.edxbaG_markdownPreview>div li:not(:first-child){margin-top:3px}.edxbaG_markdownPreview>div blockquote{margin-top:8px}.edxbaG_markdownPreview>div hr{margin:14px 0}.edxbaG_markdownPreview>div>.md-code-block{margin:10px 0}.edxbaG_assistantContent .edxbaG_markdownPayload,.edxbaG_assistantContent .edxbaG_payload{min-height:0}.edxbaG_thinkingQuote{border-left:2px solid var(--dsw-alias-markdown-citation);color:var(--dsw-alias-label-secondary);background:0 0;margin:6px 14px 0 12px;padding-left:6px}.edxbaG_thinkingQuoteOnlyPreview{margin-bottom:8px}.edxbaG_detailBody>.edxbaG_assistantContentRendered .edxbaG_thinkingQuote{margin-top:14px}.edxbaG_thinkingToggle{width:max-content;height:18px;color:var(--dsw-alias-label-tertiary);cursor:pointer;font:600 12px/18px var(--dsw-font-family);user-select:none;background:0 0;border:0;align-items:center;gap:2px;padding:0;display:flex}.edxbaG_thinkingChevron{transition:transform .12s var(--ds-ease-in-out);flex:none}.edxbaG_thinkingToggle[aria-expanded=true] .edxbaG_thinkingChevron{transform:rotate(90deg)}.edxbaG_thinkingToggle:hover{color:var(--dsw-alias-label-secondary)}.edxbaG_thinkingToggle:focus-visible{outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:2px}.edxbaG_thinkingQuote .edxbaG_markdownPreview,.edxbaG_thinkingQuote .edxbaG_markdownPayload,.edxbaG_thinkingQuote .edxbaG_payload{min-height:0;color:var(--dsw-alias-label-secondary);background:0 0;padding:2px 0}.edxbaG_assistantOutput{background:var(--dsw-alias-bg-layer-1)}.edxbaG_markdownPreview{padding:6px 14px 8px}.edxbaG_markdownPayload{min-height:100%;padding:14px}.edxbaG_jsonPayload{min-height:100%}.edxbaG_jsonPreview{min-height:0}.edxbaG_schema{background:var(--dsw-alias-bg-layer-1);min-height:100%}.edxbaG_schemaPreview{min-height:0}.edxbaG_schemaIntro{padding:12px 14px 6px}.edxbaG_schemaPreview .edxbaG_schemaIntro{padding-top:6px}.edxbaG_schemaName{color:var(--dsw-alias-label-primary);font:600 12px/18px var(--ds-font-family-code);margin:0}.edxbaG_schemaDescription{color:var(--dsw-alias-label-secondary);font:var(--dsw-font-xs-13);white-space:pre-wrap;margin:2px 0 0}.edxbaG_schemaParameters{min-width:0}.edxbaG_schemaParametersTitle{color:var(--dsw-alias-label-tertiary);font:600 11px/16px var(--dsw-font-family);user-select:none;margin:0;padding:4px 14px 2px}.edxbaG_schemaTree{margin:0 6px 8px 0}.edxbaG_payload{box-sizing:border-box;overflow-wrap:anywhere;min-height:100%;color:var(--dsw-alias-label-primary);background:var(--dsw-alias-markdown-code-block);font:12px/19px var(--ds-font-family-code);tab-size:2;white-space:pre-wrap;margin:0;padding:14px}.edxbaG_payloadPreview{min-height:0;padding:6px 14px 8px}.edxbaG_sourceBlocks{box-sizing:border-box;min-height:100%;padding:12px 14px}.edxbaG_sourceBlock+.edxbaG_sourceBlock{margin-top:14px}.edxbaG_sourceBlockHeader,.edxbaG_sourceBlockJumpTarget{user-select:none;align-items:center;gap:3px;width:max-content;margin-bottom:3px;display:flex}.edxbaG_sourceBlockJumpTarget{all:unset;cursor:pointer;user-select:none;align-items:center;gap:3px;width:max-content;margin-bottom:3px;display:flex}.edxbaG_sourceBlockLabel{color:var(--dsw-alias-label-tertiary);font:11px/16px var(--ds-font-family-code)}.edxbaG_sourceBlockJumpIcon{color:var(--dsw-alias-label-caption);flex:none}.edxbaG_sourceBlockJumpTarget:hover .edxbaG_sourceBlockJumpIcon{color:var(--dsw-alias-label-primary)}.edxbaG_sourceBlockJumpTarget:focus-visible{outline:none}.edxbaG_sourceBlockJumpTarget:focus-visible .edxbaG_sourceBlockJumpIcon{color:var(--dsw-alias-state-business-primary)}.edxbaG_sourceBlockContent{overflow-wrap:anywhere;color:var(--dsw-alias-label-primary);font:12px/19px var(--ds-font-family-code);tab-size:2;white-space:pre-wrap;background:0 0;margin:0}.edxbaG_panelImageLink{cursor:zoom-in;border-radius:4px;width:auto;max-width:100%;display:block;overflow:hidden}.edxbaG_panelImageLinkPreview{max-height:140px}.edxbaG_panelImage{border-radius:inherit;background:var(--dsw-alias-bg-base);object-fit:contain;width:auto;max-width:100%;height:auto;max-height:320px;margin:0;display:block}.edxbaG_panelImageLinkPreview .edxbaG_panelImage{max-height:140px}.edxbaG_messageImages{flex-direction:column;gap:8px;margin:8px 14px 14px;display:flex}.edxbaG_messageImagesPreview{gap:6px;margin:6px 14px 8px}.edxbaG_assistantToolCalls{box-sizing:border-box;max-width:100%;color:var(--dsw-alias-label-secondary);font:11px/17px var(--ds-font-family-code);margin:2px 14px 12px;padding:0;list-style:none}.edxbaG_assistantToolCallsPreview{margin-top:2px;margin-bottom:8px}.edxbaG_assistantToolCalls li{min-width:0}.edxbaG_assistantToolCallButton{all:unset;box-sizing:border-box;cursor:pointer;border-radius:3px;align-items:center;width:calc(100% + 4px);min-width:0;height:19px;margin-left:-4px;padding:0 4px;display:flex}.edxbaG_assistantToolCallButton:hover{background:var(--dsw-alias-interactive-bg-hover)}.edxbaG_assistantToolCallButton:focus-visible{background:var(--dsw-alias-interactive-bg-hover);outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:-1px}.edxbaG_assistantToolCallIcon{color:var(--dsw-alias-label-caption);flex:none;margin-right:5px}.edxbaG_assistantToolCallButton:hover .edxbaG_assistantToolCallIcon,.edxbaG_assistantToolCallButton:focus-visible .edxbaG_assistantToolCallIcon{color:var(--dsw-alias-label-secondary)}.edxbaG_assistantToolCallText{white-space:nowrap;flex:1;min-width:0;display:flex;overflow:hidden}.edxbaG_assistantToolCallName{color:var(--dsw-alias-label-secondary);flex:none;margin-right:5px;font-weight:500}.edxbaG_assistantToolCallArgs{min-width:0;color:var(--dsw-alias-label-tertiary);text-overflow:ellipsis;white-space:nowrap;overflow:hidden}.edxbaG_systemPrompt{box-sizing:border-box}.edxbaG_toolCatalog{min-height:100%;padding:8px 0 16px}.edxbaG_toolCatalogItem{border-bottom:1px solid var(--dsw-alias-border-l1)}.edxbaG_toolCatalogSummary{box-sizing:border-box;cursor:pointer;user-select:none;grid-template-columns:12px 12px max-content minmax(0,1fr);align-items:center;gap:5px;min-height:30px;padding:4px 12px;list-style:none;display:grid}.edxbaG_toolCatalogSummary::-webkit-details-marker{display:none}.edxbaG_toolCatalogSummary:hover{background:var(--dsw-alias-interactive-bg-hover)}.edxbaG_toolCatalogSummary:focus-visible{background:var(--dsw-alias-interactive-bg-hover);outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:-1px}.edxbaG_toolCatalogChevron,.edxbaG_toolCatalogIcon{color:var(--dsw-alias-label-caption)}.edxbaG_toolCatalogChevron{transition:transform .1s var(--ds-ease-in-out)}.edxbaG_toolCatalogItem[open] .edxbaG_toolCatalogChevron{transform:rotate(90deg)}.edxbaG_toolCatalogName{color:var(--dsw-alias-label-primary);font:500 12px/18px var(--ds-font-family-code)}.edxbaG_toolCatalogDescription{min-width:0;color:var(--dsw-alias-label-tertiary);font:var(--dsw-font-xs-13);text-overflow:ellipsis;white-space:nowrap;overflow:hidden}.edxbaG_toolCatalogDefinition{background:var(--dsw-alias-bg-base);padding:0 0 8px 29px}.edxbaG_toolCatalogFullDescription{color:var(--dsw-alias-label-secondary);font:var(--dsw-font-xs-13);white-space:pre-wrap;margin:0;padding:7px 14px 4px 0}.edxbaG_toolCatalogTree{margin-left:-14px;margin-right:6px}.edxbaG_resultBlocks{box-sizing:border-box;flex-direction:column;gap:10px;min-height:100%;padding:14px;display:flex}.edxbaG_resultBlocksPreview{gap:6px;min-height:0;padding:6px 14px 8px}.edxbaG_resultBlockText{overflow-wrap:anywhere;color:var(--dsw-alias-label-primary);font:12px/19px var(--ds-font-family-code);tab-size:2;white-space:pre-wrap;background:0 0;margin:0}.edxbaG_overviewPreview .edxbaG_noPayload{padding:6px 14px 8px}.edxbaG_noPayload{color:var(--dsw-alias-label-tertiary);font:var(--dsw-font-xs-13);margin:0;padding:18px 14px}@media (width<=760px){.edxbaG_details{z-index:5;border-left-color:var(--dsw-alias-border-l3);width:min(92%,420px);max-width:92%;position:absolute;top:0;bottom:0;right:0;box-shadow:-12px 0 32px #00000024}}";
		...
		var TrajectoryTable_module_css_default = {
			"contentColumn": "edxbaG_contentColumn",
			"panelImage": "edxbaG_panelImage",
			"markdownPayload": "edxbaG_markdownPayload",
			"detailTab": "edxbaG_detailTab",
			"usageGroup": "edxbaG_usageGroup",
			"requestDetailsName": "edxbaG_requestDetailsName",
			"payload": "edxbaG_payload",
			"trajectory-table": "edxbaG_trajectory-table",
			"sourceBlock": "edxbaG_sourceBlock",
			"sourceBlockLabel": "edxbaG_sourceBlockLabel",
			"schemaDescription": "edxbaG_schemaDescription",
			"assistantToolCallText": "edxbaG_assistantToolCallText",
			"assistantToolCallIcon": "edxbaG_assistantToolCallIcon",
			"toolCatalogDefinition": "edxbaG_toolCatalogDefinition",
			"resultBlocksPreview": "edxbaG_resultBlocksPreview",
			"overviewPreview": "edxbaG_overviewPreview",
			"kindTagLabel": "edxbaG_kindTagLabel",
			"detailBody": "edxbaG_detailBody",
			"toolCatalog": "edxbaG_toolCatalog",
			"schemaTree": "edxbaG_schemaTree",
			"arrow": "edxbaG_arrow",
			"panelImageLink": "edxbaG_panelImageLink",
			"toolCatalogName": "edxbaG_toolCatalogName",
			"historyLoadingBar": "edxbaG_historyLoadingBar",
			"overviewSection": "edxbaG_overviewSection",
			"requestDetailsDot": "edxbaG_requestDetailsDot",
			"overviewParentLinks": "edxbaG_overviewParentLinks",
			"visuallyHidden": "edxbaG_visuallyHidden",
			"split": "edxbaG_split",
			"errorPayload": "edxbaG_errorPayload",
			"toolCallOnly": "edxbaG_toolCallOnly",
			"assistantOutput": "edxbaG_assistantOutput",
			"messageImagesPreview": "edxbaG_messageImagesPreview",
			"schema": "edxbaG_schema",
			"detailsHeader": "edxbaG_detailsHeader",
			"resultBlockText": "edxbaG_resultBlockText",
			"assistantToolCallName": "edxbaG_assistantToolCallName",
			"turnLabelFull": "edxbaG_turnLabelFull",
			"assistantContent": "edxbaG_assistantContent",
			"noPayload": "edxbaG_noPayload",
			"error": "edxbaG_error",
			"sourceBlockContent": "edxbaG_sourceBlockContent",
			"subtoolAmber": "edxbaG_subtoolAmber",
			"history-loading-spin": "edxbaG_history-loading-spin",
			"details": "edxbaG_details",
			"detailBodySummary": "edxbaG_detailBodySummary",
			"message": "edxbaG_message",
			"promptDiffLineadded": "edxbaG_promptDiffLineadded",
			"toolCatalogDescription": "edxbaG_toolCatalogDescription",
			"kindTagIcon": "edxbaG_kindTagIcon",
			"detailsTitle": "edxbaG_detailsTitle",
			"compacted": "edxbaG_compacted",
			"table": "edxbaG_table",
			"historyLoading": "edxbaG_historyLoading",
			"collapsedTurnText": "edxbaG_collapsedTurnText",
			"schemaPreview": "edxbaG_schemaPreview",
			"toolCatalogFullDescription": "edxbaG_toolCatalogFullDescription",
			"usageHeading": "edxbaG_usageHeading",
			"overviewTitle": "edxbaG_overviewTitle",
			"requestBoundaryControl": "edxbaG_requestBoundaryControl",
			"systemNeutral": "edxbaG_systemNeutral",
			"jsonPreview": "edxbaG_jsonPreview",
			"sourceBlocks": "edxbaG_sourceBlocks",
			"sourceBlockJumpIcon": "edxbaG_sourceBlockJumpIcon",
			"assistantToolCallButton": "edxbaG_assistantToolCallButton",
			"messageImages": "edxbaG_messageImages",
			"virtualSpacer": "edxbaG_virtualSpacer",
			"promptDiff": "edxbaG_promptDiff",
			"usagePanel": "edxbaG_usagePanel",
			"sourceBlockJumpTarget": "edxbaG_sourceBlockJumpTarget",
			"collapsedTurnContent": "edxbaG_collapsedTurnContent",
			"kindSlot": "edxbaG_kindSlot",
			"turnLabelActive": "edxbaG_turnLabelActive",
			"jsonPayload": "edxbaG_jsonPayload",
			"panelImageLinkPreview": "edxbaG_panelImageLinkPreview",
			"resultPreview": "edxbaG_resultPreview",
			"close": "edxbaG_close",
			"user": "edxbaG_user",
			"selectionRail": "edxbaG_selectionRail",
			"overviewHierarchyJumpIconTight": "edxbaG_overviewHierarchyJumpIconTight",
			"eventColumn": "edxbaG_eventColumn",
			"eventInner": "edxbaG_eventInner",
			"toolCatalogIcon": "edxbaG_toolCatalogIcon",
			"toolCatalogTree": "edxbaG_toolCatalogTree",
			"overviewTitleIcon": "edxbaG_overviewTitleIcon",
			"promptDiffSection": "edxbaG_promptDiffSection",
			"contextGreen": "edxbaG_contextGreen",
			"thinkingChevron": "edxbaG_thinkingChevron",
			"overview": "edxbaG_overview",
			"turnRail": "edxbaG_turnRail",
			"timestampToggle": "edxbaG_timestampToggle",
			"assistantContentRendered": "edxbaG_assistantContentRendered",
			"toolCatalogItem": "edxbaG_toolCatalogItem",
			"detailsLocation": "edxbaG_detailsLocation",
			"markdownPreview": "edxbaG_markdownPreview",
			"resultRequest": "edxbaG_resultRequest",
			"assistantToolCallArgs": "edxbaG_assistantToolCallArgs",
			"promptDiffTitle": "edxbaG_promptDiffTitle",
			"event": "edxbaG_event",
			"schemaParameters": "edxbaG_schemaParameters",
			"inlineResult": "edxbaG_inlineResult",
			"collapsedTurnEllipsis": "edxbaG_collapsedTurnEllipsis",
			"detailTabActive": "edxbaG_detailTabActive",
			"tablePane": "edxbaG_tablePane",
			"noOutputText": "edxbaG_noOutputText",
			"overviewHierarchyNavLink": "edxbaG_overviewHierarchyNavLink",
			"assistantToolCallsPreview": "edxbaG_assistantToolCallsPreview",
			"historyLoadingSpinner": "edxbaG_historyLoadingSpinner",
			"requestTokenDetail": "edxbaG_requestTokenDetail",
			"content": "edxbaG_content",
			"toolAmber": "edxbaG_toolAmber",
			"detailsResizeHandle": "edxbaG_detailsResizeHandle",
			"detailTabs": "edxbaG_detailTabs",
			"promptDiffLinecontext": "edxbaG_promptDiffLinecontext",
			"schemaIntro": "edxbaG_schemaIntro",
			"turnLabel": "edxbaG_turnLabel",
			"overviewHeading": "edxbaG_overviewHeading",
			"thinkingQuote": "edxbaG_thinkingQuote",
			"historyLoadRow": "edxbaG_historyLoadRow",
			"promptDiffLinemeta": "edxbaG_promptDiffLinemeta",
			"summaryScrollRegion": "edxbaG_summaryScrollRegion",
			"assistantVioletBright": "edxbaG_assistantVioletBright",
			"toolCatalogSummary": "edxbaG_toolCatalogSummary",
			"resultBlocks": "edxbaG_resultBlocks",
			"toolCallNameTypeface": "edxbaG_toolCallNameTypeface",
			"promptDiffSections": "edxbaG_promptDiffSections",
			"historyLoadButton": "edxbaG_historyLoadButton",
			"payloadPreview": "edxbaG_payloadPreview",
			"turnLabelCompact": "edxbaG_turnLabelCompact",
			"compactedSummary": "edxbaG_compactedSummary",
			"inlineResultText": "edxbaG_inlineResultText",
			"toolCallPayload": "edxbaG_toolCallPayload",
			"requestBoundaryControlActive": "edxbaG_requestBoundaryControlActive",
			"schemaName": "edxbaG_schemaName",
			"sourceBlockHeader": "edxbaG_sourceBlockHeader",
			"kindTag": "edxbaG_kindTag",
			"schemaParametersTitle": "edxbaG_schemaParametersTitle",
			"thinkingQuoteOnlyPreview": "edxbaG_thinkingQuoteOnlyPreview",
			"toolCatalogChevron": "edxbaG_toolCatalogChevron",
			"promptDiffLineremoved": "edxbaG_promptDiffLineremoved",
			"contentText": "edxbaG_contentText",
			"assistantToolCalls": "edxbaG_assistantToolCalls",
			"overviewSections": "edxbaG_overviewSections",
			"thinkingToggle": "edxbaG_thinkingToggle",
			"systemPrompt": "edxbaG_systemPrompt",
			"eventHeader": "edxbaG_eventHeader"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:E:\ai\deepseek-harness\packages\client\ui-trajectory\src\client\TrajectoryToolbar.module.css.mjs
		const css$2 = ".nsFJvq_root{z-index:4;box-sizing:border-box;width:100%;height:var(--dsh-trajectory-toolbar-height);border-bottom:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-1);position:sticky;top:0}.nsFJvq_inner{box-sizing:border-box;align-items:center;gap:8px;width:100%;height:100%;padding:0 6px;display:flex}.nsFJvq_actions{flex:none;align-items:center;gap:2px;display:flex}.nsFJvq_toggle{height:20px;color:var(--dsw-alias-label-tertiary);cursor:pointer;font:var(--dsw-font-xxs-12);background:0 0;border:0;border-radius:3px;flex:none;align-items:center;gap:4px;padding:0 7px;display:inline-flex}.nsFJvq_toggle:hover,.nsFJvq_toggle[aria-pressed=true]{color:var(--dsw-alias-label-primary);background:var(--dsw-alias-interactive-bg-hover)}.nsFJvq_toggle:focus-visible{outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:1px}.nsFJvq_toggleIcon{stroke:currentColor;stroke-width:1.25px;stroke-linecap:round;stroke-linejoin:round;flex:none;width:12px;height:12px}.nsFJvq_control{box-sizing:border-box;width:88px;height:20px;color:var(--dsw-alias-label-tertiary);cursor:pointer;font:var(--dsw-font-xxs-12);background:0 0;border:0;border-radius:0;flex:none;justify-content:center;align-items:center;gap:4px;padding:0 5px;display:inline-flex}.nsFJvq_control[hidden]{display:none}.nsFJvq_control:hover:not(:disabled),.nsFJvq_control[aria-checked=true],.nsFJvq_control[aria-pressed=true]{color:var(--dsw-alias-label-primary)}.nsFJvq_control:focus-visible{outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:1px}.nsFJvq_control:disabled{color:var(--dsw-alias-label-dimmed);cursor:not-allowed}.nsFJvq_controlTrack{background:var(--dsw-alias-border-l2);width:20px;height:10px;transition:background-color .12s var(--ds-ease-in-out);border-radius:5px;flex:none;display:inline-block;position:relative}.nsFJvq_controlThumb{background:var(--dsw-alias-bg-layer-1);width:6px;height:6px;transition:transform .12s var(--ds-ease-in-out);border-radius:50%;position:absolute;top:2px;left:2px}.nsFJvq_controlTrack[data-on=true]{background:var(--dsw-alias-state-business-primary)}.nsFJvq_controlTrack[data-on=true] .nsFJvq_controlThumb{transform:translate(10px)}.nsFJvq_action{height:20px;color:var(--dsw-alias-label-tertiary);cursor:pointer;font:var(--dsw-font-xxs-12);background:0 0;border:0;border-radius:3px;flex:none;align-items:center;gap:4px;padding:0 5px;display:inline-flex}.nsFJvq_action:hover{color:var(--dsw-alias-label-primary);background:var(--dsw-alias-interactive-bg-hover)}.nsFJvq_action:focus-visible{outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:1px}.nsFJvq_actionIcon{color:var(--dsw-alias-label-tertiary);font:14px/14px var(--ds-font-family-code)}.nsFJvq_search{border:1px solid var(--dsw-alias-border-l2);min-width:84px;height:22px;color:var(--dsw-alias-label-caption);background:var(--dsw-alias-bg-layer-2);border-radius:4px;flex:0 164px;align-items:center;gap:4px;margin-left:auto;padding:0 6px;display:flex}.nsFJvq_search:hover{border-color:var(--dsw-alias-label-caption)}.nsFJvq_search:focus-within{border-color:var(--dsw-alias-state-business-primary);background:var(--dsw-alias-bg-layer-1)}.nsFJvq_searchIcon{flex:none}.nsFJvq_searchInput{width:100%;min-width:0;color:var(--dsw-alias-label-primary);font:var(--dsw-font-xxs-12);background:0 0;border:0;outline:0;padding:0}.nsFJvq_searchInput::placeholder{color:var(--dsw-alias-label-caption)}.nsFJvq_searchInput::-webkit-search-cancel-button{cursor:pointer;width:12px;height:12px}";
		...
		var TrajectoryToolbar_module_css_default = {
			"actionIcon": "nsFJvq_actionIcon",
			"toggleIcon": "nsFJvq_toggleIcon",
			"actions": "nsFJvq_actions",
			"inner": "nsFJvq_inner",
			"control": "nsFJvq_control",
			"search": "nsFJvq_search",
			"action": "nsFJvq_action",
			"controlThumb": "nsFJvq_controlThumb",
			"searchIcon": "nsFJvq_searchIcon",
			"controlTrack": "nsFJvq_controlTrack",
			"toggle": "nsFJvq_toggle",
			"root": "nsFJvq_root",
			"searchInput": "nsFJvq_searchInput"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:E:\ai\deepseek-harness\packages\client\ui-trajectory\src\client\TrajectoryTimeline.module.css.mjs
		const css$1 = "._9AwvIW_root{z-index:1;isolation:isolate;border-bottom:1px solid var(--dsw-alias-border-l2);user-select:none;flex:none;position:relative}._9AwvIW_root [role=tooltip]{font:var(--dsw-font-xxxs-11)}._9AwvIW_plot{background:var(--dsw-alias-bg-layer-2);grid-template-columns:44px minmax(0,1fr);height:50px;display:grid;overflow:hidden}._9AwvIW_labels{border-right:1px solid var(--dsw-alias-border-l1);color:var(--dsw-alias-label-caption);font:var(--dsw-font-xs-13);font-size:10px;line-height:1;position:relative}._9AwvIW_labels span{text-align:right;justify-content:flex-end;align-items:center;height:8px;display:flex;position:absolute;right:3px}._9AwvIW_labels span:first-child{top:7px}._9AwvIW_labels span:nth-child(2){top:21px}._9AwvIW_labels span:nth-child(3){top:35px}._9AwvIW_track{cursor:crosshair;touch-action:none;position:relative;overflow:hidden}._9AwvIW_track[data-panning=true]{cursor:grabbing}._9AwvIW_earlierHistory{z-index:5;appearance:none;box-sizing:border-box;background:linear-gradient(to right, var(--dsw-alias-bg-layer-2) 0, var(--dsw-alias-bg-layer-2) 38%, transparent 100%);width:28px;color:var(--dsw-alias-label-secondary);font:var(--dsw-font-xs-13);opacity:.72;cursor:pointer;border:0;outline:none;justify-content:flex-start;align-items:center;padding-left:3px;line-height:1;display:flex;position:absolute;top:0;bottom:0;left:0}._9AwvIW_earlierHistory:hover{opacity:1}._9AwvIW_earlierHistory[aria-disabled=true]{cursor:default}._9AwvIW_earlierHistory:focus-visible{box-shadow:inset 0 0 0 1px var(--dsw-alias-border-l2)}._9AwvIW_empty{color:var(--dsw-alias-label-caption);font:var(--dsw-font-xs-13);position:absolute;top:50%;left:50%;transform:translate(-50%,-50%)}._9AwvIW_track:focus-visible{outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:-1px}._9AwvIW_lanes{z-index:2;top:7px;bottom:7px;left:var(--trajectory-domain-left);width:var(--trajectory-domain-width);position:absolute}._9AwvIW_turnBoundaries{z-index:3;top:0;bottom:0;left:var(--trajectory-domain-left);width:var(--trajectory-domain-width);pointer-events:none;position:absolute}@media (prefers-reduced-motion:no-preference){._9AwvIW_lanes[data-animate-viewport=true],._9AwvIW_turnBoundaries[data-animate-viewport=true]{transition:left .18s ease-out}}._9AwvIW_turnBoundary{top:0;bottom:0;left:var(--trajectory-turn-left);background:var(--dsw-alias-border-l2);width:1px;position:absolute}._9AwvIW_span{top:calc(var(--trajectory-span-lane) * 14px);left:calc(var(--trajectory-span-left) + var(--trajectory-span-gap));width:max(2px, calc(var(--trajectory-span-width) - var(--trajectory-span-gap) - var(--trajectory-span-gap)));background:var(--dsw-alias-label-secondary);opacity:.78;border-radius:1px;min-width:2px;height:8px;position:absolute}._9AwvIW_span[data-timeline-span=user]{background:var(--dsw-alias-state-business-primary)}._9AwvIW_span[data-timeline-span=context]{background:color-mix(in srgb, var(--dsw-alias-state-success-primary) 68%, var(--dsw-alias-label-secondary))}._9AwvIW_span[data-timeline-span=message]{--trajectory-assistant-decoding-color:color-mix(in srgb, var(--dsw-alias-brand-primary-new-colorprimary-new-color) 60%, var(--dsw-alias-state-error-secondary));--trajectory-assistant-ttft-color:color-mix(in srgb, var(--trajectory-assistant-decoding-color) 54%, var(--dsw-alias-bg-layer-2));background:var(--trajectory-assistant-decoding-color);opacity:1}._9AwvIW_span[data-timeline-span=message][data-assistant-timing=true]{background:linear-gradient(to right, var(--trajectory-assistant-ttft-color) 0, var(--trajectory-assistant-ttft-color) var(--trajectory-assistant-ttft), var(--trajectory-assistant-decoding-color) var(--trajectory-assistant-ttft), var(--trajectory-assistant-decoding-color) 100%)}._9AwvIW_span[data-timeline-span=tool],._9AwvIW_span[data-timeline-span=subtool]{background:var(--dsw-alias-state-warn-label);opacity:1}._9AwvIW_span[data-error=true]{background:var(--dsw-alias-state-error-primary)}._9AwvIW_span[data-equal-duration=true]{width:8px;min-width:8px}._9AwvIW_span[data-selected=false]{opacity:.2}._9AwvIW_span[data-hovered=true]:not([data-current=true]){z-index:1;opacity:1;box-shadow:0 0 0 1px var(--dsw-alias-bg-layer-2), 0 0 0 2px color-mix(in srgb, var(--dsw-alias-state-business-primary) 80%, transparent)}._9AwvIW_span[data-current=true]{z-index:1;opacity:1;box-shadow:0 0 0 1px var(--dsw-alias-bg-layer-2), 0 0 0 2px var(--dsw-alias-state-business-primary)}._9AwvIW_span[data-search-match=false]{opacity:.14}._9AwvIW_selection{z-index:1;top:0;bottom:0;left:var(--trajectory-selection-left);width:var(--trajectory-selection-width);background:color-mix(in srgb, var(--dsw-alias-state-business-primary) 12%, transparent);min-width:1px;box-shadow:-100vw 0 0 100vw color-mix(in srgb, var(--dsw-alias-bg-layer-1) 58%, transparent), 100vw 0 0 100vw color-mix(in srgb, var(--dsw-alias-bg-layer-1) 58%, transparent);pointer-events:none;position:absolute}._9AwvIW_selectionEdges{z-index:4;top:0;bottom:0;left:var(--trajectory-selection-left);width:var(--trajectory-selection-width);pointer-events:none;min-width:1px;position:absolute}._9AwvIW_hoverLine{z-index:4;top:0;bottom:0;left:clamp(0px, calc(var(--trajectory-hover-left) - 1px), calc(100% - 2px));background:var(--dsw-alias-state-business-primary);pointer-events:none;width:2px;position:absolute}._9AwvIW_selectionEdges:before,._9AwvIW_selectionEdges:after{background:var(--dsw-alias-state-business-primary);content:\"\";width:3px;position:absolute;top:0;bottom:0}._9AwvIW_selectionEdges:before{left:0}._9AwvIW_selectionEdges:after{right:0}._9AwvIW_selectionEdges[data-dragging=true]:before,._9AwvIW_selectionEdges[data-dragging=true]:after{width:2px}._9AwvIW_selection[data-dragging=true]{background:color-mix(in srgb, var(--dsw-alias-state-business-primary) 18%, transparent)}";
		...
		var TrajectoryTimeline_module_css_default = {
			"lanes": "_9AwvIW_lanes",
			"selection": "_9AwvIW_selection",
			"plot": "_9AwvIW_plot",
			"root": "_9AwvIW_root",
			"empty": "_9AwvIW_empty",
			"track": "_9AwvIW_track",
			"turnBoundaries": "_9AwvIW_turnBoundaries",
			"span": "_9AwvIW_span",
			"turnBoundary": "_9AwvIW_turnBoundary",
			"hoverLine": "_9AwvIW_hoverLine",
			"labels": "_9AwvIW_labels",
			"earlierHistory": "_9AwvIW_earlierHistory",
			"selectionEdges": "_9AwvIW_selectionEdges"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:E:\ai\deepseek-harness\packages\client\ui-trajectory\src\client\views.module.css.mjs
		const css = "._0bbqeq_root{--dsh-trajectory-toolbar-height:32px;box-sizing:border-box;width:100%;height:100%;min-height:0;color:var(--dsw-alias-label-primary);background:var(--dsw-alias-bg-layer-1);flex-direction:column;display:flex;overflow:hidden}._0bbqeq_ledger{z-index:0;isolation:isolate;--dsh-trajectory-bottom-clearance:calc(var(--dsh-composer-height,152px) + 16px);flex:1;min-width:0;min-height:0;display:flex;position:relative;overflow:hidden}";
