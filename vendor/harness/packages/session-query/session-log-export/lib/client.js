window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:E:\ai\deepseek-harness\packages\session-query\session-log-export\src\client\HeaderAction.module.css.mjs
		const css = ".vptYNW_sessionLogButton{border:1px solid var(--dsw-alias-border-l2);min-width:111px;height:32px;color:var(--dsw-alias-label-primary);font-family:var(--dsw-font-family);cursor:pointer;background:0 0;border-radius:18px;justify-content:center;align-items:center;gap:4px;padding:6px 12px;font-size:13px;font-weight:400;line-height:20px;display:inline-flex}.vptYNW_sessionLogButton:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover)}.vptYNW_sessionLogButton:disabled{color:var(--dsw-alias-label-dimmed);cursor:wait}.vptYNW_sessionLogButton span,.vptYNW_sessionLogButton svg{flex:none}.vptYNW_sessionLogButton span{white-space:nowrap}";
		...
		var HeaderAction_module_css_default = { "sessionLogButton": "vptYNW_sessionLogButton" };
		//#endregion
		...
		*/
		function SessionLogDownloadHeaderAction(props) {
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("button", {
				...
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { children: "Session log" }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.IconDownloadOutline16, { size: 12 })]
